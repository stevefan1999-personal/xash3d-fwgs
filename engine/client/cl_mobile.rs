...
extern "C" {
    ...
    #[no_mangle]
    fn ID_SetCustomClientID(id: *const libc::c_char);
    #[no_mangle]
    ...
    #[no_mangle]
    fn Platform_Vibrate(life: libc::c_float, flags: libc::c_char);
    #[no_mangle]
    fn Platform_GetNativeObject(name: *const libc::c_char)
     -> *mut libc::c_void;
    #[no_mangle]
    ...
    #[no_mangle]
    fn Touch_SetClientOnly(state: byte);
    #[no_mangle]
    fn Touch_RemoveButton(name: *const libc::c_char, privileged: qboolean);
    #[no_mangle]
    fn Touch_HideButtons(name: *const libc::c_char, hide: libc::c_uchar,
                         privileged: qboolean);
    #[no_mangle]
    fn Touch_AddClientButton(name: *const libc::c_char,
                             texture: *const libc::c_char,
                             command: *const libc::c_char, x1: libc::c_float,
                             y1: libc::c_float, x2: libc::c_float,
                             y2: libc::c_float, color: *mut byte,
                             round: libc::c_int, aspect: libc::c_float,
                             flags: libc::c_int);
    #[no_mangle]
    fn Touch_AddDefaultButton(name: *const libc::c_char,
                              texturefile: *const libc::c_char,
                              command: *const libc::c_char, x1: libc::c_float,
                              y1: libc::c_float, x2: libc::c_float,
                              y2: libc::c_float, color: *mut byte,
                              round: libc::c_int, aspect: libc::c_float,
...
pub type mobile_engfuncs_t = mobile_engfuncs_s;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mobile_engfuncs_s {
    pub version: libc::c_int,
    pub pfnVibrate: Option<unsafe extern "C" fn(_: libc::c_float,
                                                _: libc::c_char) -> ()>,
    pub pfnEnableTextInput: Option<unsafe extern "C" fn(_: libc::c_int)
                                       -> ()>,
    pub pfnTouchAddClientButton: Option<unsafe extern "C" fn(_:
                                                                 *const libc::c_char,
                                                             _:
                                                                 *const libc::c_char,
                                                             _:
                                                             ...
                                                             _: libc::c_int)
                                            -> ()>,
    pub pfnTouchAddDefaultButton: Option<unsafe extern "C" fn(_:
                                                                  *const libc::c_char,
                                                              _:
                                                                  *const libc::c_char,
                                                              _:
                                                              ...
                                                              _: libc::c_int)
                                             -> ()>,
    pub pfnTouchHideButtons: Option<unsafe extern "C" fn(_:
                                                             *const libc::c_char,
                                                         _: libc::c_uchar)
                                        -> ()>,
    pub pfnTouchRemoveButton: Option<unsafe extern "C" fn(_:
                                                              *const libc::c_char)
                                         -> ()>,
    pub pfnTouchSetClientOnly: Option<unsafe extern "C" fn(_: libc::c_uchar)
                                          -> ()>,
    pub pfnTouchResetDefaultButtons: Option<unsafe extern "C" fn() -> ()>,
    pub pfnDrawScaledCharacter: Option<unsafe extern "C" fn(_: libc::c_int,
                                                            _: libc::c_int,
                                                            _: libc::c_int,
                                                            _: libc::c_int,
                                                            _: libc::c_int,
                                                            ...
                                                            _: libc::c_float)
                                           -> libc::c_int>,
    pub pfnSys_Warn: Option<unsafe extern "C" fn(_: *const libc::c_char,
                                                 _: ...) -> ()>,
    pub pfnGetNativeObject: Option<unsafe extern "C" fn(_:
                                                            *const libc::c_char)
                                       -> *mut libc::c_void>,
    pub pfnSetCustomClientID: Option<unsafe extern "C" fn(_:
                                                              *const libc::c_char)
                                         -> ()>,
...
pub type pfnMobilityInterface
    =
    Option<unsafe extern "C" fn(_: *mut mobile_engfuncs_t) -> libc::c_int>;
/*
...
*/
#[no_mangle]
pub static mut gMobileEngfuncs: *mut mobile_engfuncs_t =
    0 as *const mobile_engfuncs_t as *mut mobile_engfuncs_t;
#[no_mangle]
pub static mut vibration_length: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut vibration_enable: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
unsafe extern "C" fn pfnVibrate(mut life: libc::c_float,
                                mut flags: libc::c_char) {
    if (*vibration_enable).value == 0. { return }
    if life < 0.0f32 {
        Con_Reportf(b"^3Warning:^7 Negative vibrate time: %f\n\x00" as
                        *const u8 as *const libc::c_char,
                    life as libc::c_double);
        return
    }
...
unsafe extern "C" fn Vibrate_f() {
    if Cmd_Argc() != 2 as libc::c_int {
        Con_Printf(b"Usage: vibrate <time>\n\x00" as *const u8 as
                       *const libc::c_char);
        return
    }
    pfnVibrate(Q_atof(Cmd_Argv(1 as libc::c_int)),
               ((1 as libc::c_uint) << 0 as libc::c_int) as libc::c_char);
}
unsafe extern "C" fn pfnEnableTextInput(mut enable: libc::c_int) {
    Key_EnableTextInput(enable as qboolean, false_0);
}
unsafe extern "C" fn pfnDrawScaledCharacter(mut x: libc::c_int,
                                            mut y: libc::c_int,
 ...
 -> libc::c_int {
    let mut width: libc::c_int =
        (clgame.scrInfo.charWidths[number as usize] as libc::c_int as
             libc::c_float * scale * (*hud_scale).value) as libc::c_int;
    let mut height: libc::c_int =
        (clgame.scrInfo.iCharHeight as libc::c_float * scale *
             (*hud_scale).value) as libc::c_int;
    if cls.creditsFont.valid as u64 == 0 { return 0 as libc::c_int }
    x = (x as libc::c_float * (*hud_scale).value) as libc::c_int;
    y = (y as libc::c_float * (*hud_scale).value) as libc::c_int;
    number &= 255 as libc::c_int;
    number = Con_UtfProcessChar(number);
    if number < 32 as libc::c_int { return 0 as libc::c_int }
    if y < -height { return 0 as libc::c_int }
    pfnPIC_Set(cls.creditsFont.hFontTexture, r, g, b, 255 as libc::c_int);
    pfnPIC_DrawAdditive(x, y, width, height,
                        &mut *cls.creditsFont.fontRc.as_mut_ptr().offset(number
                                                                             as
                                                                             isize));
    return width;
}
unsafe extern "C" fn pfnGetNativeObject(mut obj: *const libc::c_char)
 -> *mut libc::c_void {
    if obj.is_null() { return 0 as *mut libc::c_void }
    // Backend should consider that obj is case-sensitive
    return Platform_GetNativeObject(obj);
}
unsafe extern "C" fn pfnTouch_HideButtons(mut name: *const libc::c_char,
                                          mut state: byte) {
    Touch_HideButtons(name, state, true_0);
}
unsafe extern "C" fn pfnTouch_RemoveButton(mut name: *const libc::c_char) {
    Touch_RemoveButton(name, true_0);
}
static mut gpMobileEngfuncs: mobile_engfuncs_t =
    unsafe {
        {
            let mut init =
                mobile_engfuncs_s{version: 2 as libc::c_int,
                                  pfnVibrate:
                                      Some(pfnVibrate as
                                  ...
                                  pfnEnableTextInput:
                                      Some(pfnEnableTextInput as
                                               unsafe extern "C" fn(_:
                                                                        libc::c_int)
                                                   -> ()),
                                  pfnTouchAddClientButton:
                                      Some(Touch_AddClientButton as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char,
                                                                    _:
                                                                        *const libc::c_char,
                                                                    ...
                                                                    _:
                                                                        libc::c_int)
                                                   -> ()),
                                  pfnTouchAddDefaultButton:
                                      Some(Touch_AddDefaultButton as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char,
                                                                    _:
                                                                        *const libc::c_char,
                                                   ...
                                                   -> ()),
                                  pfnTouchHideButtons:
                                      Some(pfnTouch_HideButtons as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char,
                                                                    _: byte)
                                                   -> ()),
                                  pfnTouchRemoveButton:
                                      Some(pfnTouch_RemoveButton as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char)
                                                   -> ()),
                                  pfnTouchSetClientOnly:
                                      Some(Touch_SetClientOnly as
                                               unsafe extern "C" fn(_: byte)
                                                   -> ()),
                                  pfnTouchResetDefaultButtons:
                                      Some(Touch_ResetDefaultButtons as
                                               unsafe extern "C" fn() -> ()),
                                  pfnDrawScaledCharacter:
                                      Some(pfnDrawScaledCharacter as
                                               unsafe extern "C" fn(_:
                                                                        libc::c_int,
                                                                    _:
                                                                        libc::c_int,
                                  ...
                                  pfnSys_Warn:
                                      Some(Sys_Warn as
                                               unsafe extern "C" fn(_:
                                                   ...
                                                   -> ()),
                                  pfnGetNativeObject:
                                      Some(pfnGetNativeObject as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char)
                                                   -> *mut libc::c_void),
                                  pfnSetCustomClientID:
                                      Some(ID_SetCustomClientID as
                                               unsafe extern "C" fn(_:
                                                                        *const libc::c_char)
                                                   -> ()),
                                  pfnParseFile:
...
#[no_mangle]
pub unsafe extern "C" fn Mobile_Init() -> qboolean {
    let mut success: qboolean = false_0;
    let mut ExportToClient: pfnMobilityInterface = None;
    // find a mobility interface
    ExportToClient =
        ::std::mem::transmute::<*mut libc::c_void,
                                pfnMobilityInterface>(COM_GetProcAddress(clgame.hInstance,
                                                                         b"HUD_MobilityInterface\x00"
                                                                             as
                                                                             *const u8
                                                                             as
                                                                             *const libc::c_char));
    gMobileEngfuncs = &mut gpMobileEngfuncs;
    if ExportToClient.is_some() &&
           ExportToClient.expect("non-null function pointer")(gMobileEngfuncs)
               == 0 {
        success = true_0
    }
    Cmd_AddCommand(b"vibrate\x00" as *const u8 as *const libc::c_char,
                   ::std::mem::transmute::<Option<unsafe extern "C" fn()
                                                      -> ()>,
                                           xcommand_t>(Some(Vibrate_f as
                                                                unsafe extern "C" fn()
                                                                    -> ())),
                   b"Vibrate for specified time\x00" as *const u8 as
                       *const libc::c_char);
    vibration_length =
        Cvar_Get(b"vibration_length\x00" as *const u8 as *const libc::c_char,
                 b"1.0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 10 as libc::c_int,
                 b"Vibration length\x00" as *const u8 as *const libc::c_char);
    vibration_enable =
        Cvar_Get(b"vibration_enable\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 10 as libc::c_int,
                 b"Enable vibration\x00" as *const u8 as *const libc::c_char);
    return success;
}
#[no_mangle]
pub unsafe extern "C" fn Mobile_Shutdown() {
    Cmd_RemoveCommand(b"vibrate\x00" as *const u8 as *const libc::c_char);
}
