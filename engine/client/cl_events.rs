...
extern "C" {
    ...
    #[no_mangle]
    static mut cl_showevents: *mut convar_t;
    #[no_mangle]
    fn MSG_ReadDeltaEvent(msg: *mut sizebuf_t, from: *mut event_args_s,
                          to: *mut event_args_s);
}
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_ResetEvent(mut ei: *mut event_info_t) {
    (*ei).index = 0 as libc::c_int as word;
    memset(&mut (*ei).args as *mut event_args_t as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<event_args_t>() as libc::c_ulong);
    (*ei).fire_time = 0.0f64 as libc::c_float;
    (*ei).flags = 0 as libc::c_int;
}
/*
=============
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_CalcPlayerVelocity(mut idx: libc::c_int,
    ...
    let ref mut fresh0 = *velocity.offset(2 as libc::c_int as isize);
    *fresh0 = 0 as libc::c_int as vec_t;
    let ref mut fresh1 = *velocity.offset(1 as libc::c_int as isize);
    *fresh1 = *fresh0;
    *velocity.offset(0 as libc::c_int as isize) = *fresh1;
    if idx <= 0 as libc::c_int || idx > cl.maxclients { return }
    if idx == cl.playernum + 1 as libc::c_int {
        pcd =
            &mut (*cl.frames.as_mut_ptr().offset(cl.parsecountmod as
                                                     isize)).clientdata;
        *velocity.offset(0 as libc::c_int as isize) =
            (*pcd).velocity[0 as libc::c_int as usize];
        *velocity.offset(1 as libc::c_int as isize) =
            (*pcd).velocity[1 as libc::c_int as usize];
        *velocity.offset(2 as libc::c_int as isize) =
            (*pcd).velocity[2 as libc::c_int as usize]
    } else {
        dt =
            ((*clgame.entities.offset(idx as isize)).curstate.animtime -
                 (*clgame.entities.offset(idx as isize)).prevstate.animtime)
                as libc::c_double;
        if dt != 0.0f64 {
            delta[0 as libc::c_int as usize] =
                (*clgame.entities.offset(idx as
                                             isize)).curstate.velocity[0 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]
                    -
                    (*clgame.entities.offset(idx as
                                                 isize)).prevstate.velocity[0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                usize];
            delta[1 as libc::c_int as usize] =
                (*clgame.entities.offset(idx as
                                             isize)).curstate.velocity[1 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]
                    -
                    (*clgame.entities.offset(idx as
                                                 isize)).prevstate.velocity[1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                usize];
            delta[2 as libc::c_int as usize] =
                (*clgame.entities.offset(idx as
                                             isize)).curstate.velocity[2 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]
                    -
                    (*clgame.entities.offset(idx as
                                                 isize)).prevstate.velocity[2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                usize];
            *velocity.offset(0 as libc::c_int as isize) =
                (delta[0 as libc::c_int as usize] as libc::c_double *
                     (1.0f32 as libc::c_double / dt)) as vec_t;
            *velocity.offset(1 as libc::c_int as isize) =
                (delta[1 as libc::c_int as usize] as libc::c_double *
                     (1.0f32 as libc::c_double / dt)) as vec_t;
            *velocity.offset(2 as libc::c_int as isize) =
                (delta[2 as libc::c_int as usize] as libc::c_double *
                     (1.0f32 as libc::c_double / dt)) as vec_t
        } else {
            *velocity.offset(0 as libc::c_int as isize) =
                (*clgame.entities.offset(idx as
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_DescribeEvent(mut ei: *mut event_info_t,
                                          mut slot: libc::c_int) {
    let mut idx: libc::c_int =
        (slot & 63 as libc::c_int) * 2 as libc::c_int; //, angles_str = { 0 };
    let mut info: con_nprint_t =
        con_nprint_t{index: 0, time_to_live: 0., color: [0.; 3],};
    let mut origin_str: string =
    ...
    if (*cl_showevents).value == 0. { return }
    info.time_to_live = 1.0f32;
    info.index = idx;
    // mark reliable as green and unreliable as red
    if (*ei).flags & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        info.color[0 as libc::c_int as usize] = 0.5f32;
        info.color[1 as libc::c_int as usize] = 1.0f32;
        info.color[2 as libc::c_int as usize] = 0.5f32
    } else {
        info.color[0 as libc::c_int as usize] = 1.0f32;
        info.color[1 as libc::c_int as usize] = 0.5f32;
        info.color[2 as libc::c_int as usize] = 0.5f32
    }
    if !((*ei).args.origin[0 as libc::c_int as usize] == 0.0f32 &&
             (*ei).args.origin[1 as libc::c_int as usize] == 0.0f32 &&
             (*ei).args.origin[2 as libc::c_int as usize] == 0.0f32) {
        Q_snprintf(origin_str.as_mut_ptr(),
                   ::std::mem::size_of::<string>() as libc::c_ulong,
                   b"(%.2f,%.2f,%.2f)\x00" as *const u8 as
                       *const libc::c_char,
                   (*ei).args.origin[0 as libc::c_int as usize] as
                       libc::c_double,
                   (*ei).args.origin[1 as libc::c_int as usize] as
                       libc::c_double,
                   (*ei).args.origin[2 as libc::c_int as usize] as
                       libc::c_double);
    }
    ...
    Con_NXPrintf(&mut info as *mut con_nprint_t,
                 b"%i %.2f %c %s %s\x00" as *const u8 as *const libc::c_char,
                 slot, cl.time,
                 if (*ei).flags & (1 as libc::c_int) << 6 as libc::c_int != 0
                    {
                     'c' as i32
                 } else if (*ei).flags &
                 ...
                 cl.event_precache[(*ei).index as usize].as_mut_ptr(),
                 origin_str.as_mut_ptr());
    info.index += 1;
    Con_NXPrintf(&mut info as *mut con_nprint_t,
                 b"b(%i,%i) i(%i,%i) f(%.2f,%.2f)\x00" as *const u8 as
                     *const libc::c_char, (*ei).args.bparam1,
                 (*ei).args.bparam2, (*ei).args.iparam1, (*ei).args.iparam2,
                 (*ei).args.fparam1 as libc::c_double,
                 (*ei).args.fparam2 as libc::c_double);
}
/*
=============
CL_SetEventIndex
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_SetEventIndex(mut szEvName: *const libc::c_char,
                                          mut ev_index: libc::c_int) {
    let mut ev: *mut cl_user_event_t =
        0 as *mut cl_user_event_t; // ignore blank names
    let mut i: libc::c_int = 0;
    if szEvName.is_null() || *szEvName == 0 { return }
    // search event by name to link with
    i = 0 as libc::c_int;
    while i < (1 as libc::c_int) << 10 as libc::c_int {
        ev = clgame.events[i as usize];
        if ev.is_null() { break ; }
        if Q_strnicmp((*ev).name.as_mut_ptr(), szEvName, 99999 as libc::c_int)
               == 0 {
            (*ev).index = ev_index as word;
            return
        }
        i += 1
    };
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_EventIndex(mut name: *const libc::c_char)
 -> word {
    let mut i: libc::c_int = 0;
    if if name.is_null() || *name == 0 {
           0 as libc::c_int
       } else { 1 as libc::c_int } == 0 {
        return 0 as libc::c_int as word
    }
    i = 1 as libc::c_int;
    while i < (1 as libc::c_int) << 10 as libc::c_int &&
              cl.event_precache[i as usize][0 as libc::c_int as usize] as
                  libc::c_int != 0 {
        if Q_strnicmp(cl.event_precache[i as usize].as_mut_ptr(), name,
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_RegisterEvent(mut lastnum: libc::c_int,
                                          mut szEvName: *const libc::c_char,
                                          mut func: pfnEventHook) {
    let mut ev: *mut cl_user_event_t = 0 as *mut cl_user_event_t;
    if lastnum == (1 as libc::c_int) << 10 as libc::c_int { return }
    // clear existing or allocate new one
    if clgame.events[lastnum as usize].is_null() {
        clgame.events[lastnum as usize] =
            _Mem_Alloc(cls.mempool,
                       ::std::mem::size_of::<cl_user_event_t>() as
                           libc::c_ulong, true_0,
                       b"../engine/client/cl_events.c\x00" as *const u8 as
                           *const libc::c_char, 189 as libc::c_int) as
                *mut cl_user_event_t
    } else {
        memset(clgame.events[lastnum as usize] as *mut libc::c_void,
               0 as libc::c_int,
               ::std::mem::size_of::<cl_user_event_t>() as libc::c_ulong);
    }
    ev = clgame.events[lastnum as usize];
    // NOTE: ev->index will be set later
    Q_strncpy((*ev).name.as_mut_ptr(), szEvName, 64 as libc::c_int as size_t);
    (*ev).func = func;
}
/*
=============
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_FireEvent(mut ei: *mut event_info_t,
                                      mut slot: libc::c_int) -> qboolean {
    let mut ev: *mut cl_user_event_t = 0 as *mut cl_user_event_t;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut i: libc::c_int = 0;
    let mut idx: libc::c_int = 0;
    if ei.is_null() || (*ei).index == 0 { return false_0 }
    ...
    while i < (1 as libc::c_int) << 10 as libc::c_int {
        ...
        if ev.is_null() {
            idx =
                if (*ei).index as libc::c_int >= 1 as libc::c_int {
                    if ((*ei).index as libc::c_int) <
                           ((1 as libc::c_int) << 10 as libc::c_int) -
                               1 as libc::c_int {
                        (*ei).index as libc::c_int
                    } else {
                        ((1 as libc::c_int) << 10 as libc::c_int) -
                            1 as libc::c_int
                    }
                } else { 1 as libc::c_int };
            Con_Reportf(b"^1Error:^7 CL_FireEvent: %s not precached\n\x00" as
                            *const u8 as *const libc::c_char,
                        cl.event_precache[idx as usize].as_mut_ptr());
            break ;
        } else if (*ev).index as libc::c_int == (*ei).index as libc::c_int {
            if (*ev).func.is_some() {
                CL_DescribeEvent(ei, slot);
                (*ev).func.expect("non-null function pointer")(&mut (*ei).args);
                return true_0
            }
            name = cl.event_precache[(*ei).index as usize].as_mut_ptr();
            Con_Reportf(b"^1Error:^7 CL_FireEvent: %s not hooked\n\x00" as
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_FireEvents() {
    ...
    while i < 64 as libc::c_int {
        ei =
            &mut *(*es).ei.as_mut_ptr().offset(i as isize) as
                *mut event_info_t;
        if !((*ei).index as libc::c_int == 0 as libc::c_int) {
            // delayed event!
            if !((*ei).fire_time != 0. &&
                     (*ei).fire_time as libc::c_double > cl.time) {
                CL_FireEvent(ei, i);
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_FindEmptyEvent() -> *mut event_info_t {
    let mut i: libc::c_int = 0;
    let mut es: *mut event_state_t = 0 as *mut event_state_t;
    let mut ei: *mut event_info_t = 0 as *mut event_info_t;
    es = &mut cl.events;
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_FindUnreliableEvent() -> *mut event_info_t {
    let mut es: *mut event_state_t = 0 as *mut event_state_t;
    let mut ei: *mut event_info_t = 0 as *mut event_info_t;
    let mut i: libc::c_int = 0;
    es = &mut cl.events;
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_QueueEvent(mut flags: libc::c_int,
                                       mut index: libc::c_int,
                                       mut delay: libc::c_float,
                                       mut args: *mut event_args_t) {
    let mut ei: *mut event_info_t = 0 as *mut event_info_t;
    // find a normal slot
    ...
    (*ei).index = index as word;
    (*ei).packet_index = 0 as libc::c_int as libc::c_short;
    (*ei).fire_time =
        if delay != 0. {
            (cl.time) + delay as libc::c_double
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_ParseReliableEvent(mut msg: *mut sizebuf_t) {
    let mut event_index: libc::c_int = 0;
    ...
    let mut args: event_args_t =
        event_args_t{flags: 0,
                     ...
                     bparam1: 0,
                     bparam2: 0,};
    let mut delay: libc::c_float = 0.0f32;
    memset(&mut nullargs as *mut event_args_t as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<event_args_t>() as libc::c_ulong);
    event_index = MSG_ReadUBitLong(msg, 10 as libc::c_int) as libc::c_int;
    if MSG_ReadOneBit(msg) != 0 {
        delay = MSG_ReadWord(msg) as libc::c_float * (1.0f32 / 100.0f32)
    }
    // reliable events not use delta-compression just null-compression
    MSG_ReadDeltaEvent(msg, &mut nullargs, &mut args);
    if args.entindex > 0 as libc::c_int && args.entindex <= cl.maxclients {
        args.angles[0 as libc::c_int as usize] *= -3.0f32
    }
    CL_QueueEvent((1 as libc::c_int) << 1 as libc::c_int |
                      (1 as libc::c_int) << 5 as libc::c_int, event_index,
                  delay, &mut args);
}
/*
=============
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_ParseEvent(mut msg: *mut sizebuf_t) {
    let mut event_index: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    let mut num_events: libc::c_int = 0;
    let mut packet_index: libc::c_int = 0;
    let mut nullargs: event_args_t =
        event_args_t{flags: 0,
                     entindex: 0,
                     origin: [0.; 3],
    ...
    memset(&mut args as *mut event_args_t as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<event_args_t>() as libc::c_ulong);
    num_events = MSG_ReadUBitLong(msg, 5 as libc::c_int) as libc::c_int;
    // parse events queue
    i = 0 as libc::c_int;
    while i < num_events {
        event_index = MSG_ReadUBitLong(msg, 10 as libc::c_int) as libc::c_int;
            ...
            packet_index =
                MSG_ReadUBitLong(msg,
                                 if cls.legacymode as libc::c_uint != 0 {
                                     12 as libc::c_int
                                 } else { 13 as libc::c_int }) as libc::c_int
        } else { packet_index = -(1 as libc::c_int) }
        if MSG_ReadOneBit(msg) != 0 {
            MSG_ReadDeltaEvent(msg, &mut nullargs, &mut args);
        }
        if MSG_ReadOneBit(msg) != 0 {
        ...
        if packet_index != -(1 as libc::c_int) {
            let mut frame: *mut frame_t =
                &mut *cl.frames.as_mut_ptr().offset(cl.parsecountmod as isize)
                    as *mut frame_t;
            if packet_index < (*frame).num_entities {
                state =
                    &mut *cls.packet_entities.offset((((*frame).first_entity +
                                                           packet_index) %
                                                          cls.num_client_entities)
                                                         as isize) as
                        *mut entity_state_t;
                args.entindex = (*state).number;
                if args.origin[0 as libc::c_int as usize] == 0.0f32 &&
                       args.origin[1 as libc::c_int as usize] == 0.0f32 &&
                       args.origin[2 as libc::c_int as usize] == 0.0f32 {
                ...
                if args.angles[0 as libc::c_int as usize] == 0.0f32 &&
                       args.angles[1 as libc::c_int as usize] == 0.0f32 &&
                       args.angles[2 as libc::c_int as usize] == 0.0f32 {
                ...
                COM_NormalizeAngles(args.angles.as_mut_ptr());
                if (*state).number > 0 as libc::c_int &&
                       (*state).number <= cl.maxclients {
                    args.angles[0 as libc::c_int as usize] *= -3.0f32;
                    CL_CalcPlayerVelocity((*state).number,
                                          args.velocity.as_mut_ptr());
                    args.ducking =
                        ((*state).usehull == 1 as libc::c_int) as libc::c_int
                }
            } else if args.entindex != 0 as libc::c_int {
                if args.entindex > 0 as libc::c_int &&
                       args.entindex <= cl.maxclients {
                    args.angles[0 as libc::c_int as usize] /= -3.0f32
                }
            }
            // Place event on queue
            CL_QueueEvent((1 as libc::c_int) << 5 as libc::c_int, event_index,
                          delay, &mut args);
        }
        i += 1
    };
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_PlaybackEvent(mut flags: libc::c_int,
    ...
    if (eventindex as libc::c_int) < 1 as libc::c_int ||
       ...
       {
        Con_DPrintf(b"^1Error:^7 CL_PlaybackEvent: invalid eventindex %i\n\x00"
                        as *const u8 as *const libc::c_char,
                    eventindex as libc::c_int);
        return
    }
    // check event for precached
    if CL_EventIndex(cl.event_precache[eventindex as usize].as_mut_ptr()) == 0
       {
        Con_DPrintf(b"^1Error:^7 CL_PlaybackEvent: event %i was not precached\n\x00"
                        as *const u8 as *const libc::c_char,
                    eventindex as libc::c_int); // it's a client event
        return
    } // fixup negative delays
    flags = flags | (1 as libc::c_int) << 6 as libc::c_int;
    flags =
        flags &
    ...
    args.velocity[0 as libc::c_int as usize] =
        cl.simvel[0 as libc::c_int as usize];
    args.velocity[1 as libc::c_int as usize] =
        cl.simvel[1 as libc::c_int as usize];
    args.velocity[2 as libc::c_int as usize] =
        cl.simvel[2 as libc::c_int as usize];
    args.entindex = cl.playernum + 1 as libc::c_int;
    args.ducking = (cl.local.usehull == 1 as libc::c_int) as libc::c_int;
    ...
    CL_QueueEvent(flags, eventindex as libc::c_int, delay, &mut args);
}
