...
extern "C" {
    ...
    #[no_mangle]
    static mut s_ziscale: libc::c_float;
    #[no_mangle]
...
unsafe extern "C" fn R_StudioComputeBBox(mut bbox: *mut vec3_t) -> qboolean {
    ...
    if bbox.is_null() && 0 as libc::c_int != 0 { return false_0 }
    return true_0;
    // visible
}
#[no_mangle]
...
unsafe extern "C" fn R_StudioCalcAttachments() {
    ...
    let mut bonepos: vec3_t = [0.; 3];
    let mut localOrg: vec3_t = [0.; 3];
    let mut localAng: vec3_t = [0.; 3];
    let mut i: libc::c_int = 0;
    // calculate attachment points
    pAtt =
        (m_pStudioHeader as
             *mut byte).offset((*m_pStudioHeader).attachmentindex as isize) as
            *mut mstudioattachment_t; // make forward
    i = 0 as libc::c_int;
    while i <
        ...
        Matrix3x4_VectorTransform(g_studio.lighttransform[(*pAtt.offset(i as
                                  ...
                                  (*RI.currententity).attachment[i as
                                                                     usize].as_mut_ptr());
        localOrg[0 as libc::c_int as usize] =
            (*RI.currententity).attachment[i as
                                               usize][0 as libc::c_int as
                                                          usize] -
                (*RI.currententity).origin[0 as libc::c_int as usize];
        localOrg[1 as libc::c_int as usize] =
            (*RI.currententity).attachment[i as
                                               usize][1 as libc::c_int as
                                                          usize] -
                (*RI.currententity).origin[1 as libc::c_int as usize];
        localOrg[2 as libc::c_int as usize] =
            (*RI.currententity).attachment[i as
                                               usize][2 as libc::c_int as
                                                          usize] -
                (*RI.currententity).origin[2 as libc::c_int as usize];
        Matrix3x4_OriginFromMatrix(g_studio.lighttransform[(*pAtt.offset(i as
                                                                             isize)).bone
                                                               as
                                                               usize].as_mut_ptr()
                                       as *const [vec_t; 4],
        ...
        forward[0 as libc::c_int as usize] =
            localOrg[0 as libc::c_int as usize] -
                bonepos[0 as libc::c_int as usize];
        forward[1 as libc::c_int as usize] =
            localOrg[1 as libc::c_int as usize] -
                bonepos[1 as libc::c_int as usize];
        forward[2 as libc::c_int as usize] =
            localOrg[2 as libc::c_int as usize] -
                bonepos[2 as libc::c_int as usize];
        let mut ilength: libc::c_float =
            rsqrt(forward[0 as libc::c_int as usize] *
                      forward[0 as libc::c_int as usize] +
                      forward[1 as libc::c_int as usize] *
                          forward[1 as libc::c_int as usize] +
                      forward[2 as libc::c_int as usize] *
                          forward[2 as libc::c_int as usize]);
        forward[0 as libc::c_int as usize] *= ilength;
        forward[1 as libc::c_int as usize] *= ilength;
        forward[2 as libc::c_int as usize] *= ilength;
        VectorAngles(forward.as_mut_ptr(), localAng.as_mut_ptr());
        i += 1
    };
}
/*
...
unsafe extern "C" fn R_StudioSetColorBegin(mut ptricmds: *mut libc::c_short,
    ...
    if g_studio.numlocallights != 0 {
        ...
        R_LightLambert(g_studio.lightpos[*ptricmds.offset(0 as libc::c_int as
                       ...
                       color.as_mut_ptr());
        //pglColor4ubv( color );
        TriColor4ub(color[0 as libc::c_int as usize],
        ...
        _TriColor4f(*lv.offset(0 as libc::c_int as isize),
                    *lv.offset(1 as libc::c_int as isize),
                    *lv.offset(2 as libc::c_int as isize), tr.blend);
    };
}
/*
====================
...
unsafe extern "C" fn R_StudioSetupSkin(mut ptexturehdr: *mut studiohdr_t,
    ...
    if g_nForceFaceFlags & 0x2 as libc::c_int != 0 {
        GL_Bind(XASH_TEXTURE0 as libc::c_int,
                tr.whiteTexture as libc::c_uint);
        return
    }
    ...
    if (*r_lightmap).value != 0. && (*r_fullbright).value == 0. {
        ...
        GL_Bind(XASH_TEXTURE0 as libc::c_int,
                (*ptexture.offset(index as isize)).index as libc::c_uint);
    };
}
/*
===============
...
pub unsafe extern "C" fn R_StudioRenderShadow(mut iSprite: libc::c_int,
    ...
    if TriSpriteTexture(gEngfuncs.pfnGetModelByIndex.expect("non-null function pointer")(iSprite),
        ...
        _TriColor4f(0.0f32, 0.0f32, 0.0f32, 1.0f32);
...
===============
*/
unsafe extern "C" fn R_StudioMeshCompare(mut a: *const sortedmesh_t,
                                         mut b: *const sortedmesh_t)
 -> libc::c_int {
    if (*a).flags & 0x20 as libc::c_int != 0 { return 1 as libc::c_int }
    if (*a).flags & 0x40 as libc::c_int != 0 { return -(1 as libc::c_int) }
...
unsafe extern "C" fn R_StudioDrawNormalMesh(mut ptricmds: *mut libc::c_short,
    ...
    loop  {
        ...
        if !(i != 0) { break ; }
        if i < 0 as libc::c_int {
            TriBegin(1 as libc::c_int);
            i = -i
        } else { TriBegin(5 as libc::c_int); }
        while i > 0 as libc::c_int {
            R_StudioSetColorBegin(ptricmds, pstudionorms);
            TriTexCoord2f(*ptricmds.offset(2 as libc::c_int as isize) as
                              libc::c_int as libc::c_float * s,
                          *ptricmds.offset(3 as libc::c_int as isize) as
                              libc::c_int as libc::c_float * t);
            TriVertex3fv(g_studio.verts[*ptricmds.offset(0 as libc::c_int as
                                                             isize) as
                                            usize].as_mut_ptr());
            i -= 1;
            ptricmds = ptricmds.offset(4 as libc::c_int as isize)
...
unsafe extern "C" fn R_StudioDrawFloatMesh(mut ptricmds: *mut libc::c_short,
    ...
    loop  {
        ...
        while i > 0 as libc::c_int {
            R_StudioSetColorBegin(ptricmds, pstudionorms);
            TriTexCoord2f(HalfToFloat(*ptricmds.offset(2 as libc::c_int as
                                                           isize) as word),
                          HalfToFloat(*ptricmds.offset(3 as libc::c_int as
                                                           isize) as word));
            TriVertex3fv(g_studio.verts[*ptricmds.offset(0 as libc::c_int as
                                                             isize) as
                                            usize].as_mut_ptr());
    ...
    loop  {
        ...
        while i > 0 as libc::c_int {
            if glowShell as u64 != 0 {
                ...
                TriColor4ub((*clr).r, (*clr).g, (*clr).b,
                            255 as libc::c_int as byte);
                TriTexCoord2f(g_studio.chrome[idx as
                                                  usize][0 as libc::c_int as
                                                             usize] * s,
                              g_studio.chrome[idx as
                                                  usize][1 as libc::c_int as
                                                             usize] * t);
                TriVertex3fv(vert.as_mut_ptr());
            } else {
                idx =
                    *ptricmds.offset(1 as libc::c_int as isize) as
                        libc::c_int;
                ...
                TriTexCoord2f(g_studio.chrome[idx as
                              ...
                              g_studio.chrome[idx as
                                                  usize][1 as libc::c_int as
                                                             usize] * t);
                TriVertex3fv(g_studio.verts[*ptricmds.offset(0 as libc::c_int
                                                                 as isize) as
                                                usize].as_mut_ptr());
            }
            i -= 1;
...
unsafe extern "C" fn R_StudioDrawPoints() {
        ...
        qsort(g_studio.meshes.as_mut_ptr() as *mut libc::c_void,
              ...
              ::std::mem::transmute::<*mut libc::c_void,
                                      __compar_fn_t>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                        ...
                                                                                        ->
                                                                                            libc::c_int>,
                                                                             *mut libc::c_void>(Some(R_StudioMeshCompare
                                                                                                         as
    ...
    while j < (*m_pSubModel).nummesh {
        ...
        if !(g_nFaceFlags & 0x40 as libc::c_int != 0) {
            if g_nFaceFlags & 0x20 as libc::c_int != 0 &&
...
unsafe extern "C" fn R_StudioDrawAbsBBox() {
    ...
    GL_Bind(XASH_TEXTURE0 as libc::c_int, tr.whiteTexture as libc::c_uint);
    _TriColor4f(0.5f32, 0.5f32, 1.0f32, 0.5f32);
...
unsafe extern "C" fn R_StudioDrawAttachments() { let mut i: libc::c_int = 0; }
/*
===============
...
pub unsafe extern "C" fn R_DrawViewModel() {
    ...
    s_ziscale =
        0x8000 as libc::c_int as libc::c_float *
            0x10000 as libc::c_int as libc::c_float * 3.0f32;
    RI.currentmodel = (*RI.currententity).model;
        ...
        tx =
            gEngfuncs._Mem_Alloc.expect("non-null function pointer")((*mod_0).mempool,
                                                                     ...
                                                                     3547 as
                                                                         libc::c_int)
                as *mut texture_t;
        let ref mut fresh9 = *(*mod_0).textures.offset(i as isize);
        *fresh9 = tx;
        // done
        if Q_strnicmp((*ptexture).name.as_mut_ptr(),
                      b"DM_Base\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn Mod_StudioUnloadTextures(mut data:
    ...
    while i < (*phdr).numtextures {
        if !((*ptexture.offset(i as isize)).index == tr.defaultTexture) {
            GL_FreeTexture((*ptexture.offset(i as isize)).index as
                               libc::c_uint);
        }
        i += 1
    };
