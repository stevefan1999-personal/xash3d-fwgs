...
extern "C" {
    ...
    #[no_mangle]
    fn R_AddDecalVBO(pdecal: *mut decal_t, surf: *mut msurface_t);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gl_polyoffset: *mut cvar_t;
    #[no_mangle]
...
unsafe extern "C" fn R_DecalUnlink(mut pdecal: *mut decal_t) {
    ...
    if !(*pdecal).psurface.is_null() {
        if (*(*pdecal).psurface).pdecals == pdecal {
            ...
            if tmp.is_null() {
                gEngfuncs.Host_Error.expect("non-null function pointer")(b"R_DecalUnlink: bad decal list\n\x00"
                                                                             as
                                                                             *const u8
                                                                             as
                                                                             *const libc::c_char);
 ...
 -> *mut glpoly_t {
    ...
    v =
        R_DecalSetupVerts(pdecal, surf, (*pdecal).texture as libc::c_int,
                          &mut lnumverts);
    if lnumverts == 0 { return 0 as *mut glpoly_t }
    // allocate glpoly
    ...
    while i < lnumverts {
        ...
        (*poly).verts[i as usize][2 as libc::c_int as usize] =
            *v.offset(2 as libc::c_int as isize);
        (*poly).verts[i as usize][3 as libc::c_int as usize] =
            *v.offset(3 as libc::c_int as isize);
        (*poly).verts[i as usize][4 as libc::c_int as usize] =
            *v.offset(4 as libc::c_int as isize);
        (*poly).verts[i as usize][5 as libc::c_int as usize] =
            *v.offset(5 as libc::c_int as isize);
        (*poly).verts[i as usize][6 as libc::c_int as usize] =
...
unsafe extern "C" fn R_AddDecalToSurface(mut pdecal: *mut decal_t,
    ...
    R_AddDecalVBO(pdecal, surf); // r_decals == 0 ???
}
    ...
    while i < (*node).numsurfaces as libc::c_int {
        ...
        if !((*surf).flags as libc::c_uint &
            ...
            if !((*surf).flags as libc::c_uint &
                     ...
                     glState.stencilEnabled as u64 == 0) {
...
pub unsafe extern "C" fn DrawSingleDecal(mut pDecal: *mut decal_t,
    ...
    v =
        R_DecalSetupVerts(pDecal, fa, (*pDecal).texture as libc::c_int,
                          &mut numVerts);
    if numVerts == 0 { return }
    GL_Bind(XASH_TEXTURE0 as libc::c_int, (*pDecal).texture as GLenum);
...
#[no_mangle]
pub unsafe extern "C" fn DrawSurfaceDecals(mut fa: *mut msurface_t,
                                           mut single: qboolean,
                                           mut reverse: qboolean) {
    let mut p: *mut decal_t = 0 as *mut decal_t;
    let mut e: *mut cl_entity_t = 0 as *mut cl_entity_t;
    if (*fa).pdecals.is_null() { return }
    e = RI.currententity;
    if e.is_null() {
        gEngfuncs.Host_Error.expect("non-null function pointer")(b"assert failed at %s:%i\n\x00"
                                                                     as
    ...
    if single as u64 != 0 {
        if (*e).curstate.rendermode == kRenderNormal as libc::c_int ||
            ...
            pglEnable.expect("non-null function pointer")(0xbe2 as libc::c_int
                                                              as GLenum);
            if (*e).curstate.rendermode == kRenderTransAlpha as libc::c_int {
        ...
        if (*e).curstate.rendermode == kRenderTransTexture as libc::c_int ||
               (*e).curstate.rendermode == kRenderTransAdd as libc::c_int {
            GL_Cull(0 as libc::c_int as GLenum);
        }
        if (*gl_polyoffset).value != 0. {
            pglEnable.expect("non-null function pointer")(0x8037 as
                                                              libc::c_int as
                                                              GLenum);
            pglPolygonOffset.expect("non-null function pointer")(-1.0f32,
                                                                 -(*gl_polyoffset).value);
        }
    }
    if (*fa).flags as libc::c_uint & (1 as libc::c_uint) << 8 as libc::c_int
           != 0 && glState.stencilEnabled as libc::c_uint != 0 {
        let mut tex: *mut mtexinfo_t = (*fa).texinfo;
        p = (*fa).pdecals;
        while !p.is_null() {
            if (*p).texture != 0 {
                ...
                let mut numVerts: libc::c_int = 0;
                o =
                    R_DecalSetupVerts(p, fa, (*p).texture as libc::c_int,
                                      &mut numVerts);
                pglEnable.expect("non-null function pointer")(0xb90 as
                                                                  libc::c_int
                                                                  as GLenum);
                pglStencilFunc.expect("non-null function pointer")(0x207 as
                                                                       libc::c_int
                                                                       as
                                                                       GLenum,
                                                                   1 as
                                                                   ...
                                                                   0xffffffff
                                                                       as
                                                                       libc::c_uint);
                pglColorMask.expect("non-null function pointer")(0 as
                                                                     libc::c_int
                                                                     as
                                                                     GLboolean,
                                                                 0 as
                                                                 ...
                                                                 0 as
                                                                     ...
                                                                     as
                                                                     GLboolean);
                pglStencilOp.expect("non-null function pointer")(0x1e00 as
                                                                     libc::c_int
                                                                     as
                                                                     GLenum,
                                                                 0x1e00 as
                             ...
                             *v.offset(2 as libc::c_int as isize) *
                             ...
                             (*tex).vecs[0 as libc::c_int as
                                             usize][3 as libc::c_int as
                                                        usize]) /
                            (*(*tex).texture).width as libc::c_float;
                    *v.offset(6 as libc::c_int as isize) =
                        (*v.offset(0 as libc::c_int as isize) *
                             (*tex).vecs[1 as libc::c_int as
                                             usize][0 as libc::c_int as usize]
                             +
                             *v.offset(1 as libc::c_int as isize) *
                                 (*tex).vecs[1 as libc::c_int as
                             ...
                             *v.offset(2 as libc::c_int as isize) *
                             ...
                             (*tex).vecs[1 as libc::c_int as
                                             usize][3 as libc::c_int as
                                                        usize]) /
                            (*(*tex).texture).height as libc::c_float;
                ...
                pglDisable.expect("non-null function pointer")(0xbc0 as
                                                                   libc::c_int
                                                                   as GLenum);
                pglColorMask.expect("non-null function pointer")(0x1 as
                                                                     libc::c_int
                                                                     as
                                                                     GLboolean,
                                                                 0x1 as
    ...
    pglBlendFunc.expect("non-null function pointer")(0x302 as libc::c_int as
                                                     ...
                                                     0x303 as libc::c_int as
                                                         GLenum);
    if reverse as libc::c_uint != 0 &&
           (*e).curstate.rendermode == kRenderTransTexture as libc::c_int {
        let mut list: [*mut decal_t; 1024] = [0 as *mut decal_t; 1024];
        let mut i_0: libc::c_int = 0;
        let mut count: libc::c_int = 0;
        p = (*fa).pdecals;
        count = 0 as libc::c_int;
        while !p.is_null() && count < 1024 as libc::c_int {
            if (*p).texture != 0 {
                let fresh5 = count;
                count = count + 1;
                list[fresh5 as usize] = p
            }
            p = (*p).pnext
        }
        i_0 = count - 1 as libc::c_int;
        while i_0 >= 0 as libc::c_int {
            DrawSingleDecal(list[i_0 as usize], fa);
            i_0 -= 1
        }
    } else {
        p = (*fa).pdecals;
        while !p.is_null() {
            if !((*p).texture == 0) { DrawSingleDecal(p, fa); }
            p = (*p).pnext
        }
    }
    if (*fa).flags as libc::c_uint & (1 as libc::c_uint) << 8 as libc::c_int
    ...
    if single as u64 != 0 {
        ...
        if (*e).curstate.rendermode == kRenderTransAdd as libc::c_int ||
               (*e).curstate.rendermode == kRenderGlow as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn DrawDecalsBatch() {
    let mut e: *mut cl_entity_t = 0 as *mut cl_entity_t;
    let mut i: libc::c_int = 0;
    if tr.num_draw_decals == 0 { return }
    e = RI.currententity;
    if e.is_null() {
        gEngfuncs.Host_Error.expect("non-null function pointer")(b"assert failed at %s:%i\n\x00"
                                                                     as
    ...
    if (*gl_polyoffset).value != 0. {
        pglEnable.expect("non-null function pointer")(0x8037 as libc::c_int as
                                                          GLenum);
        pglPolygonOffset.expect("non-null function pointer")(-1.0f32,
                                                             -(*gl_polyoffset).value);
    }
    i = 0 as libc::c_int;
    while i < tr.num_draw_decals {
        DrawSurfaceDecals(tr.draw_decals[i as usize], false_0, false_0);
        i += 1
    }
    if (*e).curstate.rendermode != kRenderTransTexture as libc::c_int {
    ...
    if (*gl_polyoffset).value != 0. {
        pglDisable.expect("non-null function pointer")(0x8037 as libc::c_int
                                                           as GLenum);
    }
    if (*e).curstate.rendermode == kRenderTransTexture as libc::c_int ||
           (*e).curstate.rendermode == kRenderTransAdd as libc::c_int {
