...
extern "C" {
    ...
    fn AVI_GetVideoInfo(Avi: *mut movie_state_t, xres: *mut libc::c_int,
     ...
     -> qboolean;
    #[no_mangle]
    fn AVI_LoadVideo(filename: *const libc::c_char, load_audio: qboolean)
     -> *mut movie_state_t;
    #[no_mangle]
    fn AVI_IsActive(Avi: *mut movie_state_t) -> qboolean;
    #[no_mangle]
    fn AVI_FreeVideo(Avi: *mut movie_state_t);
    #[no_mangle]
    ...
    #[no_mangle]
    fn pfnSPR_LoadExt(szPicName: *const libc::c_char, texFlags: uint)
     -> HSPRITE;
    #[no_mangle]
    fn S_FadeMusicVolume(fadePercent: libc::c_float);
    #[no_mangle]
    fn S_StreamAviSamples(Avi: *mut libc::c_void, entnum: libc::c_int,
                          fvol: libc::c_float, attn: libc::c_float,
                          synctime: libc::c_float);
    #[no_mangle]
...
*/
#[no_mangle]
pub unsafe extern "C" fn R_FatPVS(mut org: *const vec_t,
                                  mut radius: libc::c_float,
                                  mut visbuffer: *mut byte,
                                  mut merge: qboolean, mut fullvis: qboolean)
 -> libc::c_int {
    return Mod_FatPVS(org, radius, visbuffer, world.visbytes as libc::c_int,
                      merge, fullvis);
}
#[no_mangle]
pub unsafe extern "C" fn CL_GetLightStyle(mut number: libc::c_int)
 -> *mut lightstyle_t {
    return &mut *cl.lightstyles.as_mut_ptr().offset(number as isize) as
               *mut lightstyle_t;
}
#[no_mangle]
pub unsafe extern "C" fn GL_GetOverviewParms() -> *const ref_overview_t {
    return &mut clgame.overView;
}
unsafe extern "C" fn R_Mem_Alloc(mut cb: size_t,
                                 mut filename: *const libc::c_char,
                                 fileline: libc::c_int) -> *mut libc::c_void {
    return _Mem_Alloc(cls.mempool, cb, true_0, filename, fileline);
}
unsafe extern "C" fn R_Mem_Free(mut mem: *mut libc::c_void,
                                mut filename: *const libc::c_char,
                                fileline: libc::c_int) {
 ...
 -> *mut *mut libc::c_char {
    ...
    if !t.is_null() {
        _Mem_Free(t as *mut libc::c_void,
                  b"../engine/client/cl_render.c\x00" as *const u8 as
...
unsafe extern "C" fn pfnFileBufferCRC32(mut buffer: *const libc::c_void,
                                        length: libc::c_int) -> uint {
    let mut modelCRC: uint = 0 as libc::c_int as uint;
    if buffer.is_null() || length <= 0 as libc::c_int { return modelCRC }
    CRC32_Init(&mut modelCRC);
    CRC32_ProcessBuffer(&mut modelCRC, buffer, length);
...
=================
*/
unsafe extern "C" fn R_EnvShot(mut vieworg: *const libc::c_float,
                               mut name: *const libc::c_char,
                               mut skyshot: qboolean,
                               mut shotsize: libc::c_int) {
    static mut viewPoint: vec3_t = [0.; 3]; // use client view
    ...
    if cls.scrshot_action as libc::c_uint !=
           scrshot_inactive as libc::c_int as libc::c_uint {
        if cls.scrshot_action as libc::c_uint !=
               scrshot_skyshot as libc::c_int as libc::c_uint &&
               cls.scrshot_action as libc::c_uint !=
                   scrshot_envshot as libc::c_int as libc::c_uint {
            Con_Printf(b"^1Error:^7 R_%sShot: subsystem is busy, try for next frame.\n\x00"
    ...
    Q_strncpy(cls.shotname.as_mut_ptr(), name,
              ::std::mem::size_of::<string>() as libc::c_ulong);
    if !vieworg.is_null() {
        // make sure what viewpoint don't temporare
        viewPoint[0 as libc::c_int as usize] =
            *vieworg.offset(0 as libc::c_int as isize);
        viewPoint[1 as libc::c_int as usize] =
            *vieworg.offset(1 as libc::c_int as isize);
        viewPoint[2 as libc::c_int as usize] =
            *vieworg.offset(2 as libc::c_int as isize);
        cls.envshot_vieworg = viewPoint.as_mut_ptr();
        cls.envshot_disable_vis = true_0
    }
    ...
    cls.envshot_viewsize =
        if 0 as libc::c_int > shotsize { 0 as libc::c_int } else { shotsize };
}
/*
=============
CL_GenericHandle
...
*/
#[no_mangle]
pub unsafe extern "C" fn CL_GenericHandle(mut fileindex: libc::c_int)
 -> *const libc::c_char {
    if fileindex < 0 as libc::c_int ||
           fileindex >= (1 as libc::c_int) << 10 as libc::c_int {
        return 0 as *const libc::c_char
    }
    return cl.files_precache[fileindex as usize].as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn CL_RenderGetParm(parm: libc::c_int, arg: libc::c_int,
                                          checkRef: qboolean) -> libc::c_int {
    match parm {
        16 => { return 0 as libc::c_int }
        17 => {
            return (world.flags as libc::c_uint &
                        (1 as libc::c_uint) << 0 as libc::c_int != 0 &&
                        world.flags as libc::c_uint &
                            (1 as libc::c_uint) << 1 as libc::c_int == 0) as
                       libc::c_int
        }
        18 => { return cl.paused as libc::c_int }
        25 => { return CL_IsInGame() as libc::c_int }
        20 => { return clgame.maxEntities }
        26 => { return host.features as libc::c_int }
        19 => {
            return (world.flags as libc::c_uint &
        ...
        32 => {
            return (host.type_0 ==
                        HOST_DEDICATED as libc::c_int as libc::c_uint) as
                       libc::c_int
        }
        37 => {
            return (world.flags as libc::c_uint &
        ...
        39 => {
            return *(&mut world.deluxedata as *mut *mut color24 as
                         *mut libc::c_int)
        }
        40 => {
            return *(&mut world.shadowdata as *mut *mut byte as
                         *mut libc::c_int)
        }
        _ => {
            // indicates call from client.dll
            if checkRef as u64 != 0 {
                return ref_0.dllFuncs.RefGetParm.expect("non-null function pointer")(parm,
                                                                                     arg)
            } else {
                // call issued from ref_dll, check extensions here
                match parm {
                    -1 => { return CL_IsDevOverviewMode() }
                    -2 => { return CL_IsThirdPerson() as libc::c_int }
                    -3 => { return Host_IsQuakeCompatible() as libc::c_int }
                    -4 => { return cl.playernum + 1 as libc::c_int }
                    -5 => { return cl.viewentity }
                    -6 => { return cls.state as libc::c_int }
                    -7 => { return cls.demoplayback }
                    -8 => { return cl.local.waterlevel }
                    -9 => { return cl.maxclients }
                    -10 => { return cl.local.health }
                    -11 => { return Host_IsLocalGame() as libc::c_int }
                    -12 => { return pfnNumberOfEntities() }
                    -13 => { return cl.nummodels }
                    _ => { }
                }
            }
        }
...
unsafe extern "C" fn pfnRenderGetParm(mut parm: libc::c_int,
                                      mut arg: libc::c_int) -> libc::c_int {
    return CL_RenderGetParm(parm, arg, true_0);
}
static mut gRenderAPI: render_api_t =
    unsafe {
        {
            let mut init =
                render_api_s{RenderGetParm:
                                 Some(pfnRenderGetParm as
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut libc::c_void>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                               ...
                                                                                                                               ->
                                                                                                                                   *mut movie_state_t>,
                                                                                                                    *mut libc::c_void>(Some(AVI_LoadVideo
                                                                                                                                                as
                                                                                                                                                unsafe extern "C" fn(_:
                                                                                                                                                                         *const libc::c_char,
                                                                                                                                                                     _:
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        libc::c_int>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                         ...
                                                                                                                         ->
                                                                                                                             qboolean>,
                                                                                                              *mut libc::c_void>(Some(AVI_GetVideoInfo
                                                                                                                                          as
                                                                                                                                          unsafe extern "C" fn(_:
                                                                                                                                                                   *mut movie_state_t,
                                                                                                                                                               _:
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        libc::c_int>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                         ...
                                                                                                                         ->
                                                                                                                             libc::c_int>,
                                                                                                              *mut libc::c_void>(Some(AVI_GetVideoFrameNumber
                                                                                                                                          as
                                                                                                                                          unsafe extern "C" fn(_:
                                                                                                                                                                   *mut movie_state_t,
                                                                                                                                                               _:
                                 ...
                                 ::std::mem::transmute::<*mut libc::c_void,
                                                         Option<unsafe extern "C" fn(_:
                                                                                     ...
                                                                                     _:
                                                                                         libc::c_int)
                                                                    ->
                                                                        *mut byte>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                                            *mut movie_state_t,
                                                                                                                                        _:
                                                                                                                                            libc::c_int)
                                                                                                                       ->
                                                                                                                           *mut byte>,
                                                                                                            *mut libc::c_void>(Some(AVI_GetVideoFrame
                                                                                                                                        as
                                                                                                                                        unsafe extern "C" fn(_:
                                                                                                                                                                 *mut movie_state_t,
                                                                                                                                                             _:
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        ()>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                ...
                                                                                                                ->
                                                                                                                    ()>,
                                                                                                     *mut libc::c_void>(Some(AVI_FreeVideo
                                                                                                                                 as
                                                                                                                                 unsafe extern "C" fn(_:
                                                                                                                                                          *mut movie_state_t)
                                                                                                                                     ->
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        libc::c_int>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                         ...
                                                                                                                         ->
                                                                                                                             qboolean>,
                                                                                                              *mut libc::c_void>(Some(AVI_IsActive
                                                                                                                                          as
                                                                                                                                          unsafe extern "C" fn(_:
                                                                                                                                                                   *mut movie_state_t)
                                                                                                                                              ->
                                                         ...
                                                         Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut libc::c_void>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                               ...
                                                                                                                               ->
                                                                                                                                   *mut model_t>,
                                                                                                                    *mut libc::c_void>(Some(CL_ModelHandle
                                                                                                                                                as
                                                                                                                                                unsafe extern "C" fn(_:
                                                                                                                                                                         libc::c_int)
                                                                                                                                                    ->
...
unsafe extern "C" fn R_FillRenderAPIFromRef(mut to: *mut render_api_t,
                                            mut from:
                                                *const ref_interface_t) {
...
*/
#[no_mangle]
pub unsafe extern "C" fn R_InitRenderAPI() -> qboolean {
    // make sure what render functions is cleared
    memset(&mut clgame.drawFuncs as *mut render_interface_t as
               *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<render_interface_t>() as libc::c_ulong);
    // fill missing functions from renderer
    R_FillRenderAPIFromRef(&mut gRenderAPI, &mut ref_0.dllFuncs);
    if clgame.dllFuncs.pfnGetRenderInterface.is_some() {
        if clgame.dllFuncs.pfnGetRenderInterface.expect("non-null function pointer")(37
                                                                                         as
                                                                                         libc::c_int,
                                                                                     &mut gRenderAPI,
                                                                                     &mut clgame.drawFuncs)
               != 0 {
            Con_Reportf(b"CL_LoadProgs: ^2initailized extended RenderAPI ^7ver. %i\n\x00"
                            as *const u8 as *const libc::c_char,
                        37 as libc::c_int);
            return true_0
        }
