...
extern "C" {
    ...
    #[no_mangle]
    fn R_Init_Video(type_0: libc::c_int) -> qboolean;
    #[no_mangle]
    fn R_Free_Video();
    #[no_mangle]
    fn GL_GetProcAddress(name: *const libc::c_char) -> *mut libc::c_void;
    #[no_mangle]
    fn GL_SetAttribute(attr: libc::c_int, val: libc::c_int) -> libc::c_int;
    #[no_mangle]
    fn GL_GetAttribute(attr: libc::c_int, val: *mut libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    fn GL_SwapBuffers();
    #[no_mangle]
    fn SW_LockBuffer() -> *mut libc::c_void;
    #[no_mangle]
    fn SW_UnlockBuffer();
    #[no_mangle]
    fn SW_CreateBuffer(width: libc::c_int, height: libc::c_int,
                       stride: *mut uint, bpp: *mut uint, r: *mut uint,
                       g: *mut uint, b: *mut uint) -> qboolean;
    #[no_mangle]
    ...
    fn _Sys_GetParmFromCmdLine(parm: *const libc::c_char,
     ...
     -> qboolean;
    #[no_mangle]
    fn Sys_GetIntFromCmdLine(parm: *const libc::c_char, out: *mut libc::c_int)
     -> qboolean;
    #[no_mangle]
    ...
    #[no_mangle]
    fn COM_SetRandomSeed(lSeed: libc::c_int);
    #[no_mangle]
    ...
    #[no_mangle]
    fn Cmd_AddRefCommand(cmd_name: *const libc::c_char, function: xcommand_t,
                         description: *const libc::c_char) -> libc::c_int;
    #[no_mangle]
    ...
    fn FS_FileExists(filename: *const libc::c_char, gamedironly: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    fn Image_AddCmdFlags(flags: uint);
    #[no_mangle]
    fn FS_LoadImage(filename: *const libc::c_char, buffer: *const byte,
                    size: size_t) -> *mut rgbdata_t;
    #[no_mangle]
    fn FS_SaveImage(filename: *const libc::c_char, pix: *mut rgbdata_t)
     -> qboolean;
    #[no_mangle]
    fn FS_CopyImage(in_0: *mut rgbdata_t) -> *mut rgbdata_t;
    #[no_mangle]
    fn FS_FreeImage(pack: *mut rgbdata_t);
    #[no_mangle]
    static PFDesc: [bpc_desc_t; 0];
    #[no_mangle]
    fn Image_Process(pix: *mut *mut rgbdata_t, width: libc::c_int,
                     height: libc::c_int, flags: uint,
                     bumpscale: libc::c_float) -> qboolean;
    #[no_mangle]
    fn Image_SetForceFlags(flags: uint);
    #[no_mangle]
    fn Image_CustomPalette() -> qboolean;
    #[no_mangle]
    fn Image_ClearForceFlags();
    #[no_mangle]
    fn Image_SetMDLPointer(p: *mut byte);
    #[no_mangle]
    ...
    #[no_mangle]
    fn PM_TraceLine(start: *mut libc::c_float, end: *mut libc::c_float,
                    flags: libc::c_int, usehull: libc::c_int,
                    ignore_pe: libc::c_int) -> *mut pmtrace_s;
    #[no_mangle]
    ...
    #[no_mangle]
    fn Mod_CreatePolygonsForHull(hullnum: libc::c_int);
    #[no_mangle]
    fn R_StudioSlerpBones(numbones: libc::c_int, q1: *mut vec4_t,
                          pos1: *mut [libc::c_float; 3], q2: *mut vec4_t,
                          pos2: *mut [libc::c_float; 3], s: libc::c_float);
    #[no_mangle]
    fn R_StudioCalcBoneQuaternion(frame: libc::c_int, s: libc::c_float,
                                  pbone: *mut mstudiobone_t,
                                  panim: *mut mstudioanim_t,
                                  adj: *mut libc::c_float, q: *mut vec_t);
    #[no_mangle]
    fn R_StudioCalcBonePosition(frame: libc::c_int, s: libc::c_float,
                                pbone: *mut mstudiobone_t,
                                panim: *mut mstudioanim_t, adj: *mut vec_t,
                                pos: *mut vec_t);
    #[no_mangle]
    fn R_StudioGetAnim(m_pStudioHeader: *mut studiohdr_t,
                       m_pSubModel: *mut model_t,
                       pseqdesc: *mut mstudioseqdesc_t) -> *mut libc::c_void;
    #[no_mangle]
    ...
    #[no_mangle]
    fn pfnGetMoveVars() -> *mut movevars_t;
    #[no_mangle]
    ...
    #[no_mangle]
    fn pfnGetPhysent(idx: libc::c_int) -> *mut physent_t;
    #[no_mangle]
    fn GL_GetOverviewParms() -> *const ref_overview_t;
    #[no_mangle]
    fn R_FatPVS(org: *const vec_t, radius: libc::c_float,
                visbuffer: *mut byte, merge: qboolean, fullvis: qboolean)
     -> libc::c_int;
    #[no_mangle]
    fn CL_GetEntityLight(number: libc::c_int) -> *mut dlight_t;
    #[no_mangle]
    fn CL_GetDynamicLight(number: libc::c_int) -> *mut dlight_t;
    #[no_mangle]
    fn CL_GetLightStyle(number: libc::c_int) -> *mut lightstyle_t;
    #[no_mangle]
    static mut cls: client_static_t;
    #[no_mangle]
    static mut gameui: gameui_static_t;
    #[no_mangle]
    fn CL_TextMessageGet(pName: *const libc::c_char)
     -> *mut client_textmessage_t;
    #[no_mangle]
    fn CL_UpdateRemapInfo(ent: *mut cl_entity_t, topcolor: libc::c_int,
                          bottomcolor: libc::c_int);
    #[no_mangle]
    fn CL_FreeRemapInfo(info: *mut remap_info_t);
    #[no_mangle]
    fn CL_AllocRemapInfo(entity: *mut cl_entity_t, model: *mut model_t,
                         topcolor: libc::c_int, bottomcolor: libc::c_int);
    #[no_mangle]
    fn CL_GetRemapInfoForEntity(e: *mut cl_entity_t) -> *mut remap_info_t;
    #[no_mangle]
    fn CL_ModelHandle(modelindex: libc::c_int) -> *mut model_t;
    #[no_mangle]
    fn R_StoreEfrags(ppefrag: *mut *mut efrag_t, framecount: libc::c_int);
    #[no_mangle]
    fn R_FreeDeadParticles(ppparticles: *mut *mut particle_s);
    #[no_mangle]
    fn CL_ThinkParticle(frametime: libc::c_double, p: *mut particle_t);
    #[no_mangle]
    fn CL_DrawEFX(time: libc::c_float, fTrans: qboolean);
    #[no_mangle]
    fn CL_AddVisibleEntity(ent: *mut cl_entity_t, entityType: libc::c_int)
     -> qboolean;
    #[no_mangle]
    fn CL_GetWaterEntity(rgflPos: *const libc::c_float) -> *mut cl_entity_t;
    #[no_mangle]
    fn R_BeamGetEntity(index: libc::c_int) -> *mut cl_entity_t;
    #[no_mangle]
    fn CL_GetViewModel() -> *mut cl_entity_t;
    #[no_mangle]
    fn CL_GetLocalPlayer() -> *mut cl_entity_t;
    #[no_mangle]
    fn CL_DrawCenterPrint();
    #[no_mangle]
    ...
    #[no_mangle]
    fn CL_RenderGetParm(parm: libc::c_int, arg: libc::c_int,
                        checkRef: qboolean) -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn CL_AllocParticleFast() -> *mut particle_s;
    #[no_mangle]
    ...
    #[no_mangle]
    fn TriWorldToScreen(world_0: *const libc::c_float,
                        screen: *mut libc::c_float) -> libc::c_int;
    #[no_mangle]
    fn TriBoxInPVS(mins: *mut libc::c_float, maxs: *mut libc::c_float)
     -> libc::c_int;
    #[no_mangle]
    fn TriLightAtPoint(pos: *mut libc::c_float, value: *mut libc::c_float);
    #[no_mangle]
    fn TriColor4fRendermode(r: libc::c_float, g: libc::c_float,
    ...
    fn TriSpriteTexture(pSpriteModel: *mut model_t, frame: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
    static mut cl_sprite_dot: *mut model_t;
    #[no_mangle]
    static mut cl_sprite_shell: *mut model_t;
    #[no_mangle]
...
pub type REFAPI
    =
    Option<unsafe extern "C" fn(_: libc::c_int, _: *mut ref_interface_t,
                                _: *mut ref_api_t, _: *mut ref_globals_t)
               -> libc::c_int>;
pub type REF_HUMANREADABLE_NAME
    =
...
#[export_name = "ref"]
pub static mut ref_0: ref_state_s =
    ref_state_s{initialized: false_0,
                hInstance: 0 as *const libc::c_void as *mut libc::c_void,
                dllFuncs:
                    ref_interface_t{R_Init: None,
                                    R_Shutdown: None,
                                    R_GetConfigName: None,
                                    R_SetDisplayTransform: None,
                                    GL_SetupAttributes: None,
                                    GL_InitExtensions: None,
                                    GL_ClearExtensions: None,
                                    R_BeginFrame: None,
                                    R_RenderScene: None,
                                    R_EndFrame: None,
                                    R_PushScene: None,
                                    R_PopScene: None,
                                    GL_BackendStartFrame: None,
                                    GL_BackendEndFrame: None,
                                    R_ClearScreen: None,
                                    R_AllowFog: None,
                                    GL_SetRenderMode: None,
                                    R_AddEntity: None,
                                    CL_AddCustomBeam: None,
                                    R_ProcessEntData: None,
                                    R_ShowTextures: None,
                                    R_GetTextureOriginalBuffer: None,
                                    GL_LoadTextureFromBuffer: None,
                                    GL_ProcessTexture: None,
                                    R_SetupSky: None,
                                    R_Set2DMode: None,
                                    R_DrawStretchRaw: None,
                                    R_DrawStretchPic: None,
                                    R_DrawTileClear: None,
                                    FillRGBA: None,
                                    FillRGBABlend: None,
                                    WorldToScreen: None,
                                    VID_ScreenShot: None,
                                    VID_CubemapShot: None,
                                    R_LightPoint: None,
                                    R_DecalShoot: None,
                                    R_DecalRemoveAll: None,
                                    R_CreateDecalList: None,
                                    R_ClearAllDecals: None,
                                    R_StudioEstimateFrame: None,
                                    R_StudioLerpMovement: None,
                                    CL_InitStudioAPI: None,
                                    R_InitSkyClouds: None,
                                    GL_SubdivideSurface: None,
                                    CL_RunLightStyles: None,
                                    R_GetSpriteParms: None,
                                    R_GetSpriteTexture: None,
                                    Mod_LoadMapSprite: None,
                                    Mod_ProcessRenderData: None,
                                    Mod_StudioLoadTextures: None,
                                    CL_DrawParticles: None,
                                    CL_DrawTracers: None,
                                    CL_DrawBeams: None,
                                    R_BeamCull: None,
                                    RefGetParm: None,
                                    GetDetailScaleForTexture: None,
                                    GetExtraParmsForTexture: None,
                                    GetFrameTime: None,
                                    R_SetCurrentEntity: None,
                                    R_SetCurrentModel: None,
                                    GL_FindTexture: None,
                                    GL_TextureName: None,
                                    GL_TextureData: None,
                                    GL_LoadTexture: None,
                                    GL_CreateTexture: None,
                                    GL_LoadTextureArray: None,
                                    GL_CreateTextureArray: None,
                                    GL_FreeTexture: None,
                                    DrawSingleDecal: None,
                                    R_DecalSetupVerts: None,
                                    R_EntityRemoveDecals: None,
                                    AVI_UploadRawFrame: None,
                                    GL_Bind: None,
                                    GL_SelectTexture: None,
                                    GL_LoadTextureMatrix: None,
                                    GL_TexMatrixIdentity: None,
                                    GL_CleanUpTextureUnits: None,
                                    GL_TexGen: None,
                                    GL_TextureTarget: None,
                                    GL_TexCoordArrayMode: None,
                                    GL_UpdateTexSize: None,
                                    GL_Reserved0: None,
                                    GL_Reserved1: None,
                                    GL_DrawParticles: None,
                                    LightVec: None,
                                    StudioGetTexture: None,
                                    GL_RenderFrame: None,
                                    GL_OrthoBounds: None,
                                    ...
                                    CullFace: None,
                                    VGUI_DrawInit: None,
                                    VGUI_DrawShutdown: None,
                                    VGUI_SetupDrawingText: None,
                                    VGUI_SetupDrawingRect: None,
                                    VGUI_SetupDrawingImage: None,
                                    VGUI_BindTexture: None,
                                    VGUI_EnableTexture: None,
                                    VGUI_CreateTexture: None,
                                    VGUI_UploadTexture: None,
                                    VGUI_UploadTextureBlock: None,
                                    VGUI_DrawQuad: None,
                                    VGUI_GetTextureSizes: None,
                                    VGUI_GenerateTexture: None,},
                numRenderers: 0,
                shortNames: [[0; 256]; 5],
                readableNames: [[0; 256]; 5],};
#[no_mangle]
pub static mut refState: ref_globals_t =
    ref_globals_t{developer: false_0,
                  time: 0.,
                  oldtime: 0.,
                  realtime: 0.,
                  frametime: 0.,
                  ...
                  vup: [0.; 3],
                  draw_surfaces:
                      0 as *const sortedface_t as *mut sortedface_t,
                  max_surfaces: 0,
                  visbytes: 0,
                  desktopBitsPixel: 0,};
#[no_mangle]
pub static mut gl_vsync: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut gl_showtextures: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut r_decals: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut r_adjust_fov: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut r_showtree: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut gl_msaa_samples: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut gl_clear: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut r_refdll: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub unsafe extern "C" fn R_GetTextureParms(mut w: *mut libc::c_int,
    ...
    if !w.is_null() {
        *w =
            ref_0.dllFuncs.RefGetParm.expect("non-null function pointer")(1 as
                                                                              libc::c_int,
                                                                          texnum)
    }
    if !h.is_null() {
        *h =
            ref_0.dllFuncs.RefGetParm.expect("non-null function pointer")(2 as
                                                                              libc::c_int,
                                                                          texnum)
    };
}
...
*/
#[no_mangle]
pub unsafe extern "C" fn GL_FreeImage(mut name: *const libc::c_char) {
    let mut texnum: libc::c_int = 0;
    if ref_0.initialized as u64 == 0 { return }
    texnum =
        ref_0.dllFuncs.GL_FindTexture.expect("non-null function pointer")(name);
    if texnum != 0 as libc::c_int {
        ref_0.dllFuncs.GL_FreeTexture.expect("non-null function pointer")(texnum
                                                                              as
                                                                              libc::c_uint);
    };
}
#[no_mangle]
pub unsafe extern "C" fn R_UpdateRefState() {
    refState.time = cl.time as libc::c_float;
    refState.oldtime = cl.oldtime as libc::c_float;
    refState.realtime = host.realtime;
    refState.frametime = host.frametime;
}
#[no_mangle]
pub unsafe extern "C" fn GL_RenderFrame(mut rvp: *const ref_viewpass_t) {
    R_UpdateRefState();
    ...
    AngleVectors(refState.viewangles.as_mut_ptr() as *const vec_t,
                 refState.vforward.as_mut_ptr(), refState.vright.as_mut_ptr(),
                 refState.vup.as_mut_ptr());
    ref_0.dllFuncs.GL_RenderFrame.expect("non-null function pointer")(rvp);
}
unsafe extern "C" fn pfnEngineGetParm(mut parm: libc::c_int,
                                      mut arg: libc::c_int) -> libc::c_int {
    return CL_RenderGetParm(parm, arg, false_0);
    // prevent recursion
}
unsafe extern "C" fn pfnGetWorld() -> *mut world_static_t {
    return &mut world;
}
unsafe extern "C" fn pfnStudioEvent(mut event: *const mstudioevent_t,
                                    mut e: *const cl_entity_t) {
    clgame.dllFuncs.pfnStudioEvent.expect("non-null function pointer")(event,
                                                                       e);
}
unsafe extern "C" fn pfnGetDefaultSprite(mut spr: ref_defaultsprite_e)
 -> *mut model_t {
    match spr as libc::c_uint {
        0 => { return cl_sprite_dot }
        1 => { return cl_sprite_shell }
        _ => {
            Host_Error(b"GetDefaultSprite: unknown sprite %d\n\x00" as
...
unsafe extern "C" fn pfnMod_Extradata(mut type_0: libc::c_int,
                                      mut m: *mut model_t)
 -> *mut libc::c_void {
    match type_0 {
        2 => { return Mod_AliasExtradata(m) }
        3 => { return Mod_StudioExtradata(m) }
        1 | 0 => {
            // fallthrough
            return 0 as *mut libc::c_void
        }
        _ => {
            Host_Error(b"Mod_Extradata: unknown type %d\n\x00" as *const u8 as
                           *const libc::c_char, type_0);
        }
    }
    return 0 as *mut libc::c_void;
}
unsafe extern "C" fn pfnMod_GetCurrentLoadingModel() -> *mut model_t {
    return loadmodel;
}
unsafe extern "C" fn pfnMod_SetCurrentLoadingModel(mut m: *mut model_t) {
    loadmodel = m;
}
unsafe extern "C" fn pfnGetPredictedOrigin(mut v: *mut vec_t) {
...
unsafe extern "C" fn pfnCL_GetPaletteColor(mut color: libc::c_int)
 -> *mut color24 
 // clgame.palette[color]
 {
    return &mut *clgame.palette.as_mut_ptr().offset(color as isize) as
               *mut color24;
}
unsafe extern "C" fn pfnCL_GetScreenInfo(mut width: *mut libc::c_int,
                                         mut height: *mut libc::c_int) 
 // clgame.scrInfo, ptrs may be NULL
 {
    if !width.is_null() { *width = clgame.scrInfo.iWidth }
    if !height.is_null() { *height = clgame.scrInfo.iHeight };
}
unsafe extern "C" fn pfnSetLocalLightLevel(mut level: libc::c_int) {
...
===============
*/
unsafe extern "C" fn pfnPlayerInfo(mut index: libc::c_int)
 -> *mut player_info_t {
    if index == -(1 as libc::c_int) {
        // special index for menu
        return &mut gameui.playerinfo
    }
    if index < 0 as libc::c_int || index > cl.maxclients {
        return 0 as *mut player_info_t
    }
    return &mut *cl.players.as_mut_ptr().offset(index as isize) as
               *mut player_info_t;
}
/*
===============
...
===============
*/
unsafe extern "C" fn R_StudioGetPlayerState(mut index: libc::c_int)
 -> *mut entity_state_t {
    if index < 0 as libc::c_int || index >= cl.maxclients {
        return 0 as *mut entity_state_t
    }
    return &mut *(*cl.frames.as_mut_ptr().offset(cl.parsecountmod as
                                                     isize)).playerstate.as_mut_ptr().offset(index
                                                                                                 as
                                                                                                 isize)
               as *mut entity_state_t;
}
unsafe extern "C" fn pfnGetStudioModelInterface(mut version: libc::c_int,
                                                mut ppinterface:
                                                    *mut *mut r_studio_interface_s,
                                                mut pstudio:
                                                    *mut engine_studio_api_s)
 -> libc::c_int {
    return if clgame.dllFuncs.pfnGetStudioModelInterface.is_some() {
               clgame.dllFuncs.pfnGetStudioModelInterface.expect("non-null function pointer")(version,
                                                                                              ppinterface,
                                                                                              pstudio)
           } else { 0 as libc::c_int };
}
unsafe extern "C" fn pfnImage_GetPool() -> poolhandle_t {
    return host.imagepool;
}
unsafe extern "C" fn pfnImage_GetPFDesc(mut idx: libc::c_int)
 -> *const bpc_desc_t {
    return &*PFDesc.as_ptr().offset(idx as isize) as *const bpc_desc_t;
}
unsafe extern "C" fn pfnDrawNormalTriangles() {
    clgame.dllFuncs.pfnDrawNormalTriangles.expect("non-null function pointer")();
}
unsafe extern "C" fn pfnDrawTransparentTriangles() {
    clgame.dllFuncs.pfnDrawTransparentTriangles.expect("non-null function pointer")();
}
unsafe extern "C" fn pfnRefGetScreenFade() -> *mut screenfade_t {
    return &mut clgame.fade;
}
/*
===============
R_DoResetGamma
...
===============
*/
unsafe extern "C" fn R_DoResetGamma() -> qboolean {
    match cls.scrshot_action as libc::c_uint {
        5 | 6 => { return true_0 }
        _ => { return false_0 }
    };
}
unsafe extern "C" fn R_Init_Video_(type_0: libc::c_int) -> qboolean {
    host.apply_opengl_config = true_0;
    Cbuf_AddText(va(b"exec %s.cfg\x00" as *const u8 as *const libc::c_char,
                    ref_0.dllFuncs.R_GetConfigName.expect("non-null function pointer")()));
    Cbuf_Execute();
    host.apply_opengl_config = false_0;
    return R_Init_Video(type_0);
}
...
unsafe extern "C" fn R_UnloadProgs() {
    if ref_0.hInstance.is_null() { return }
    // deinitialize renderer
    ref_0.dllFuncs.R_Shutdown.expect("non-null function pointer")(); // single export
    Cvar_FullSet(b"host_refloaded\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 17 as libc::c_int);
    COM_FreeLibrary(ref_0.hInstance);
    ref_0.hInstance = 0 as *mut libc::c_void;
    memset(&mut refState as *mut ref_globals_t as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<ref_globals_t>() as libc::c_ulong);
    memset(&mut ref_0.dllFuncs as *mut ref_interface_t as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<ref_interface_t>() as libc::c_ulong);
    Cvar_Unlink((1 as libc::c_int) << 16 as libc::c_int |
                    (1 as libc::c_int) << 12 as libc::c_int);
    Cmd_Unlink(((1 as libc::c_uint) << 5 as libc::c_int) as libc::c_int);
}
unsafe extern "C" fn CL_FillTriAPIFromRef(mut dst: *mut triangleapi_t,
                                          mut src: *const ref_interface_t) {
    (*dst).version = 1 as libc::c_int;
    (*dst).Begin = (*src).Begin;
    (*dst).RenderMode =
        Some(TriRenderMode as unsafe extern "C" fn(_: libc::c_int) -> ());
    (*dst).End = (*src).End;
    (*dst).Color4f =
        Some(TriColor4f as
    ...
    (*dst).Color4ub =
        Some(TriColor4ub as
                 unsafe extern "C" fn(_: byte, _: byte, _: byte, _: byte)
                     -> ());
    (*dst).TexCoord2f = (*src).TexCoord2f;
    (*dst).Vertex3f = (*src).Vertex3f;
    (*dst).Vertex3fv = (*src).Vertex3fv;
    (*dst).Brightness =
        Some(TriBrightness as unsafe extern "C" fn(_: libc::c_float) -> ());
    (*dst).CullFace =
        Some(TriCullFace as unsafe extern "C" fn(_: TRICULLSTYLE) -> ());
    (*dst).SpriteTexture =
        Some(TriSpriteTexture as
                 unsafe extern "C" fn(_: *mut model_t, _: libc::c_int)
                     -> libc::c_int);
    (*dst).WorldToScreen =
        Some(TriWorldToScreen as
                 unsafe extern "C" fn(_: *const libc::c_float,
    ...
    (*dst).BoxInPVS =
        Some(TriBoxInPVS as
                 unsafe extern "C" fn(_: *mut libc::c_float,
                                      _: *mut libc::c_float) -> libc::c_int);
    (*dst).LightAtPoint =
        Some(TriLightAtPoint as
                 unsafe extern "C" fn(_: *mut libc::c_float,
                                      _: *mut libc::c_float) -> ());
    (*dst).Color4fRendermode =
        Some(TriColor4fRendermode as
                 unsafe extern "C" fn(_: libc::c_float, _: libc::c_float,
                                      _: libc::c_float, _: libc::c_float,
                                      _: libc::c_int) -> ());
    (*dst).FogParams = (*src).FogParams;
}
unsafe extern "C" fn R_LoadProgs(mut name: *const libc::c_char) -> qboolean {
    extern "C" {
        #[link_name = "gTriApi"]
        static mut gTriApi_0: triangleapi_t;
    }
    static mut gpEngfuncs: ref_api_t =
        ref_api_t{EngineGetParm: None,
                  Cvar_Get: None,
                  pfnGetCvarPointer: None,
                  pfnGetCvarFloat: None,
                  ...
                  pfnDrawTransparentTriangles: None,
                  drawFuncs:
                      0 as *const render_interface_t as
                          *mut render_interface_t,};
    let mut GetRefAPI: REFAPI = None;
    if !ref_0.hInstance.is_null() { R_UnloadProgs(); }
    FS_AllowDirectPaths(true_0);
    ref_0.hInstance = COM_LoadLibrary(name, false_0 as libc::c_int, true_0);
    if ref_0.hInstance.is_null() {
        FS_AllowDirectPaths(false_0);
        Con_Reportf(b"R_LoadProgs: can\'t load renderer library %s: %s\n\x00"
    ...
    GetRefAPI =
        ::std::mem::transmute::<*mut libc::c_void,
                                REFAPI>(COM_GetProcAddress(ref_0.hInstance,
                                                           b"GetRefAPI\x00" as
                                                               *const u8 as
                                                               *const libc::c_char));
    if GetRefAPI.is_none() {
        COM_FreeLibrary(ref_0.hInstance);
        Con_Reportf(b"R_LoadProgs: can\'t find GetRefAPI entry point in %s\n\x00"
                        as *const u8 as *const libc::c_char, name);
        ref_0.hInstance = 0 as *mut libc::c_void;
        return false_0
    }
    // make local copy of engfuncs to prevent overwrite it with user dll
    memcpy(&mut gpEngfuncs as *mut ref_api_t as *mut libc::c_void,
           &mut gEngfuncs as *mut ref_api_t as *const libc::c_void,
           ::std::mem::size_of::<ref_api_t>() as
               libc::c_ulong); //, ref.dllFuncs.R_GetInitError() );
    if GetRefAPI.expect("non-null function pointer")(1 as libc::c_int,
                                                     &mut ref_0.dllFuncs,
                                                     &mut gpEngfuncs,
                                                     &mut refState) == 0 {
        COM_FreeLibrary(ref_0.hInstance);
        Con_Reportf(b"R_LoadProgs: can\'t init renderer API: wrong version\n\x00"
                        as *const u8 as *const libc::c_char);
        ref_0.hInstance = 0 as *mut libc::c_void;
        return false_0
    }
    refState.developer = host_developer.value as qboolean;
    if ref_0.dllFuncs.R_Init.expect("non-null function pointer")() as u64 == 0
       {
        COM_FreeLibrary(ref_0.hInstance);
        Con_Reportf(b"R_LoadProgs: can\'t init renderer!\n\x00" as *const u8
    ...
    Cvar_FullSet(b"host_refloaded\x00" as *const u8 as *const libc::c_char,
                 ...
                 (1 as libc::c_int) << 17 as libc::c_int);
    ref_0.initialized = true_0;
    // initialize TriAPI callbacks
    CL_FillTriAPIFromRef(&mut gTriApi, &mut ref_0.dllFuncs);
    return true_0;
}
#[no_mangle]
pub unsafe extern "C" fn R_Shutdown() {
    ...
    memset(clgame.sprites.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<[model_t; 256]>() as libc::c_ulong);
    // correctly free all models before render unload
	// change this if need add online render changing
    Mod_FreeAll();
    R_UnloadProgs();
    ref_0.initialized = false_0;
}
unsafe extern "C" fn R_GetRendererName(mut dest: *mut libc::c_char,
                                       mut size: size_t,
                                       mut opt: *const libc::c_char) {
    if Q_strstr(opt, b".so\x00" as *const u8 as *const libc::c_char).is_null()
       {
        let mut format: *const libc::c_char = 0 as *const libc::c_char;
        if Q_strncmp(opt, b"ref_\x00" as *const u8 as *const libc::c_char,
                     99999 as libc::c_int) == 0 {
            format = b"lib%s.so\x00" as *const u8 as *const libc::c_char
        } else {
            format = b"libref_%s.so\x00" as *const u8 as *const libc::c_char
        }
        Q_snprintf(dest, size, format, opt);
    } else {
        // full path
        Q_strncpy(dest, opt, 99999 as libc::c_int as size_t);
    };
}
unsafe extern "C" fn R_LoadRenderer(mut refopt: *const libc::c_char)
 -> qboolean {
    let mut refdll: string = [0; 256];
    R_GetRendererName(refdll.as_mut_ptr(),
                      ::std::mem::size_of::<string>() as libc::c_ulong,
                      refopt);
    Con_Printf(b"Loading renderer: %s -> %s\n\x00" as *const u8 as
                   *const libc::c_char, refopt, refdll.as_mut_ptr());
    if R_LoadProgs(refdll.as_mut_ptr()) as u64 == 0 {
        R_Shutdown();
        Sys_Warn(b"^1Error:^7 Can\'t initialize %s renderer!\n\x00" as
                     *const u8 as *const libc::c_char, refdll.as_mut_ptr());
        return false_0
    }
    Con_Reportf(b"Renderer %s initialized\n\x00" as *const u8 as
                    *const libc::c_char, refdll.as_mut_ptr());
    return true_0;
}
unsafe extern "C" fn SetWidthAndHeightFromCommandLine() {
    let mut width: libc::c_int = 0;
    let mut height: libc::c_int = 0;
    Sys_GetIntFromCmdLine(b"-width\x00" as *const u8 as *const libc::c_char,
                          &mut width);
    Sys_GetIntFromCmdLine(b"-height\x00" as *const u8 as *const libc::c_char,
                          &mut height);
...
unsafe extern "C" fn SetFullscreenModeFromCommandLine() {
    if Sys_CheckParm(b"-fullscreen\x00" as *const u8 as *const libc::c_char)
           != 0 {
        Cvar_Set(b"fullscreen\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char);
    } else if Sys_CheckParm(b"-windowed\x00" as *const u8 as
                                *const libc::c_char) != 0 {
        Cvar_Set(b"fullscreen\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char);
    };
...
#[no_mangle]
pub unsafe extern "C" fn R_CollectRendererNames() {
    let mut renderers: [*const libc::c_char; 5] =
        [b"gl\x00" as *const u8 as *const libc::c_char,
         b"gles1\x00" as *const u8 as *const libc::c_char,
         b"gles2\x00" as *const u8 as *const libc::c_char,
         b"gl4es\x00" as *const u8 as *const libc::c_char,
         b"soft\x00" as *const u8 as *const libc::c_char];
    let mut i: libc::c_int = 0;
    ...
    while i < 5 as libc::c_int {
        ...
        let mut dll: *mut libc::c_void = 0 as *mut libc::c_void;
        let mut pfn: *mut libc::c_void = 0 as *mut libc::c_void;
        R_GetRendererName(temp.as_mut_ptr(),
                          ::std::mem::size_of::<string>() as libc::c_ulong,
                          renderers[i as usize]);
        dll =
            COM_LoadLibrary(temp.as_mut_ptr(), false_0 as libc::c_int,
                            true_0);
        if dll.is_null() {
            Con_Reportf(b"R_CollectRendererNames: can\'t load library %s: %s\n\x00"
                            as *const u8 as *const libc::c_char,
                        temp.as_mut_ptr(), COM_GetLibraryError());
        } else {
            pfn =
                COM_GetProcAddress(dll,
                                   b"GetRefAPI\x00" as *const u8 as
                                       *const libc::c_char);
            if pfn.is_null() {
                Con_Reportf(b"R_CollectRendererNames: can\'t find API entry point in %s\n\x00"
                                as *const u8 as *const libc::c_char,
                            temp.as_mut_ptr());
                COM_FreeLibrary(dll);
            } else {
                Q_strncpy(ref_0.shortNames[cur as usize].as_mut_ptr(),
                          renderers[i as usize],
                          ::std::mem::size_of::<string>() as libc::c_ulong);
                pfn =
                    COM_GetProcAddress(dll,
                                       b"GetRefHumanReadableName\x00" as
                                           *const u8 as *const libc::c_char);
                if pfn.is_null() {
                    // just in case
                    Con_Reportf(b"R_CollectRendererNames: can\'t find GetHumanReadableName export in %s\n\x00"
                                    as *const u8 as *const libc::c_char,
                                temp.as_mut_ptr());
                    Q_strncpy(ref_0.readableNames[cur as usize].as_mut_ptr(),
                              renderers[i as usize],
                              ::std::mem::size_of::<string>() as
                                  libc::c_ulong);
                } else {
                    let mut GetHumanReadableName: REF_HUMANREADABLE_NAME =
                        ::std::mem::transmute::<*mut libc::c_void,
                                                REF_HUMANREADABLE_NAME>(pfn);
                    GetHumanReadableName.expect("non-null function pointer")(ref_0.readableNames[cur
                                                                                                     as
                                                                                                     usize].as_mut_ptr(),
                ...
                Con_Printf(b"Found renderer %s: %s\n\x00" as *const u8 as
                               *const libc::c_char,
                           ref_0.shortNames[cur as usize].as_mut_ptr(),
                           ref_0.readableNames[cur as usize].as_mut_ptr());
                cur += 1;
                COM_FreeLibrary(dll);
            }
        }
    ...
    ref_0.numRenderers = cur;
}
#[no_mangle]
pub unsafe extern "C" fn R_Init() -> qboolean {
    let mut success: qboolean = false_0;
    let mut requested: string = [0; 256];
    gl_vsync =
        Cvar_Get(b"gl_vsync\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"enable vertical syncronization\x00" as *const u8 as
                     *const libc::c_char);
    gl_showtextures =
        Cvar_Get(b"r_showtextures\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 15 as libc::c_int,
                 b"show all uploaded textures\x00" as *const u8 as
                     *const libc::c_char);
    r_adjust_fov =
        Cvar_Get(b"r_adjust_fov\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"making FOV adjustment for wide-screens\x00" as *const u8 as
                     *const libc::c_char);
    r_decals =
        Cvar_Get(b"r_decals\x00" as *const u8 as *const libc::c_char,
                 b"4096\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"sets the maximum number of decals\x00" as *const u8 as
                     *const libc::c_char);
    gl_msaa_samples =
        Cvar_Get(b"gl_msaa_samples\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 12 as libc::c_int,
                 b"samples number for multisample anti-aliasing\x00" as
                     *const u8 as *const libc::c_char);
    gl_clear =
        Cvar_Get(b"gl_clear\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"clearing screen after each frame\x00" as *const u8 as
                     *const libc::c_char);
    r_showtree =
        Cvar_Get(b"r_showtree\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"build the graph of visible BSP tree\x00" as *const u8 as
                     *const libc::c_char);
    r_refdll =
        Cvar_Get(b"r_refdll\x00" as *const u8 as *const libc::c_char,
                 b"\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 16 as libc::c_int |
                     (1 as libc::c_int) << 20 as libc::c_int,
                 b"choose renderer implementation, if supported\x00" as
                     *const u8 as *const libc::c_char);
    // cvars that are expected to exist by client.dll
	// refdll should just get pointer to them
    Cvar_Get(b"r_drawentities\x00" as *const u8 as *const libc::c_char,
             b"1\x00" as *const u8 as *const libc::c_char,
             (1 as libc::c_int) << 15 as libc::c_int,
             b"render entities\x00" as *const u8 as *const libc::c_char);
    Cvar_Get(b"cl_himodels\x00" as *const u8 as *const libc::c_char,
             b"1\x00" as *const u8 as *const libc::c_char,
             (1 as libc::c_int) << 0 as libc::c_int,
             b"draw high-resolution player models in multiplayer\x00" as
                 *const u8 as *const libc::c_char);
    // cvars are created, execute video config
    Cbuf_AddText(b"exec video.cfg\x00" as *const u8 as *const libc::c_char);
    Cbuf_Execute();
    ...
    requested[0 as libc::c_int as usize] = '\u{0}' as i32 as libc::c_char;
    if _Sys_GetParmFromCmdLine(b"-ref\x00" as *const u8 as
                                   *const libc::c_char,
                               requested.as_mut_ptr(),
                               ::std::mem::size_of::<string>() as
                                   libc::c_ulong) as u64 == 0 &&
           (if (*r_refdll).string.is_null() || *(*r_refdll).string == 0 {
                0 as libc::c_int
            } else { 1 as libc::c_int }) != 0 {
        // r_refdll is set to empty by default, so we can change hardcoded defaults just in case
        Q_strncpy(requested.as_mut_ptr(), (*r_refdll).string,
                  ::std::mem::size_of::<string>() as libc::c_ulong);
    }
    if requested[0 as libc::c_int as usize] != 0 {
        success = R_LoadRenderer(requested.as_mut_ptr())
    }
    if success as u64 == 0 {
        let mut i: libc::c_int = 0;
        // cycle through renderers that we collected in CollectRendererNames
        i = 0 as libc::c_int;
        while i < ref_0.numRenderers {
            // skip renderer that was requested but failed to load
            if !(Q_strncmp(requested.as_mut_ptr(),
                           ref_0.shortNames[i as usize].as_mut_ptr(),
                           99999 as libc::c_int) == 0) {
                success =
                    R_LoadRenderer(ref_0.shortNames[i as usize].as_mut_ptr());
                // yay, found working one
                if success as u64 != 0 { break ; }
            }
            i += 1
        }
    }
    if success as u64 == 0 {
        Host_Error(b"Can\'t initialize any renderer. Check your video drivers!\x00"
                       as *const u8 as *const libc::c_char);
        return false_0
    }
    SCR_Init();
...
unsafe extern "C" fn run_static_initializers() {
    gEngfuncs =
        {
            let mut init =
                ref_api_s{EngineGetParm:
                              Some(pfnEngineGetParm as
                              ...
                              ::std::mem::transmute::<*mut libc::c_void,
                                                      Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *const libc::c_char)
                                                                 ->
                                                                     *mut cvar_t>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                                           *const libc::c_char,
                                                                                                                                       _:
                                                                                                                                           *const libc::c_char,
                                                                                                                                       _:
                                                      ...
                                                      Option<unsafe extern "C" fn(_:
                                                                 ...
                                                                 ->
                                                                     *mut cvar_t>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                      ...
                                                                                                                      ->
                                                                                                                          *mut convar_t>,
                                                                                                           *mut libc::c_void>(Some(Cvar_FindVarExt
                                                                                                                                       as
                                                                                                                                       unsafe extern "C" fn(_:
                                                                                                                                                                *const libc::c_char,
                                                                                                                                                            _:
                                                      ...
                                                      Option<unsafe extern "C" fn(_:
                                                                 ...
                                                                 ->
                                                                     ()>>(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                             ...
                                                                                                             ->
                                                                                                                 ()>,
                                                                                                  *mut libc::c_void>(Some(Cvar_RegisterVariable
                                                                                                                              as
                                                                                                                              unsafe extern "C" fn(_:
                                                                                                                                                       *mut convar_t)
                                                                                                                                  ->
                          ...
                          Cmd_Args:
                              Some(Cmd_Args as
                                       unsafe extern "C" fn()
                                           -> *const libc::c_char),
                          Cbuf_AddText:
                              Some(Cbuf_AddText as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_char)
                                           -> ()),
                          Cbuf_InsertText:
                              Some(Cbuf_InsertText as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_char)
                                           -> ()),
                          Cbuf_Execute:
                              Some(Cbuf_Execute as
                                       unsafe extern "C" fn() -> ()),
                          Con_Printf:
                              Some(Con_Printf as
                                       unsafe extern "C" fn(_:
                          ...
                          GetEntityByIndex:
                              Some(CL_GetEntityByIndex as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut cl_entity_s),
                          R_BeamGetEntity:
                              Some(R_BeamGetEntity as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut cl_entity_t),
                          CL_GetWaterEntity:
                              Some(CL_GetWaterEntity as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_float)
                                           -> *mut cl_entity_t),
                          CL_AddVisibleEntity:
                              Some(CL_AddVisibleEntity as
                                       unsafe extern "C" fn(_:
                                                                *mut cl_entity_t,
                                                            _: libc::c_int)
                                           -> qboolean),
                          Mod_SampleSizeForFace:
                              Some(Mod_SampleSizeForFace as
                                       unsafe extern "C" fn(_:
                                                                *mut msurface_t)
                                           -> libc::c_int),
                          Mod_BoxVisible:
                              Some(Mod_BoxVisible as
                          ...
                          GetWorld:
                              Some(pfnGetWorld as
                                       unsafe extern "C" fn()
                                           -> *mut world_static_t),
                          Mod_PointInLeaf:
                              Some(Mod_PointInLeaf as
                                       unsafe extern "C" fn(_: *const vec_t,
                                                            _: *mut mnode_t)
                                           -> *mut mleaf_t),
                          Mod_CreatePolygonsForHull:
                              Some(Mod_CreatePolygonsForHull as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> ()),
                          R_StudioSlerpBones:
                              Some(R_StudioSlerpBones as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: *mut vec4_t,
                                                            _:
                                                                *mut [libc::c_float; 3],
                          ...
                          R_StudioCalcBoneQuaternion:
                              Some(R_StudioCalcBoneQuaternion as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: libc::c_float,
                                                            _:
                                                                *mut mstudiobone_t,
                          ...
                          R_StudioCalcBonePosition:
                              Some(R_StudioCalcBonePosition as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: libc::c_float,
                                                            _:
                                                                *mut mstudiobone_t,
                          ...
                          R_StudioGetAnim:
                              Some(R_StudioGetAnim as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> *mut libc::c_void),
                          pfnStudioEvent:
                              Some(pfnStudioEvent as
                                       unsafe extern "C" fn(_:
                                                                *const mstudioevent_t,
                                                            _:
                                                                *const cl_entity_t)
                                           -> ()),
                          CL_DrawEFX:
                              Some(CL_DrawEFX as
                                       unsafe extern "C" fn(_: libc::c_float,
                                                            _: qboolean)
                                           -> ()),
                          CL_ThinkParticle:
                              Some(CL_ThinkParticle as
                                       unsafe extern "C" fn(_: libc::c_double,
                                                            _:
                                                                *mut particle_t)
                                           -> ()),
                          R_FreeDeadParticles:
                              Some(R_FreeDeadParticles as
                                       unsafe extern "C" fn(_:
                                                                *mut *mut particle_s)
                                           -> ()),
                          CL_AllocParticleFast:
                              Some(CL_AllocParticleFast as
                                       unsafe extern "C" fn()
                                           -> *mut particle_s),
                          CL_AllocElight:
                              Some(CL_AllocElight as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut dlight_s),
                          GetDefaultSprite:
                              Some(pfnGetDefaultSprite as
                                       unsafe extern "C" fn(_:
                                                                ref_defaultsprite_e)
                                           -> *mut model_t),
                          R_StoreEfrags:
                              Some(R_StoreEfrags as
                                       unsafe extern "C" fn(_:
                                                                *mut *mut efrag_t,
                                                            _: libc::c_int)
                                           -> ()),
                          Mod_ForName:
                              Some(Mod_ForName as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> *mut model_t),
                          Mod_Extradata:
                              Some(pfnMod_Extradata as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: *mut model_t)
                                           -> *mut libc::c_void),
                          pfnGetModelByIndex:
                              Some(CL_ModelHandle as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut model_t),
                          Mod_GetCurrentLoadingModel:
                              Some(pfnMod_GetCurrentLoadingModel as
                                       unsafe extern "C" fn()
                                           -> *mut model_t),
                          Mod_SetCurrentLoadingModel:
                              Some(pfnMod_SetCurrentLoadingModel as
                                       unsafe extern "C" fn(_: *mut model_t)
                                           -> ()),
                          CL_GetRemapInfoForEntity:
                              Some(CL_GetRemapInfoForEntity as
                                       unsafe extern "C" fn(_:
                                                                *mut cl_entity_t)
                                           -> *mut remap_info_t),
                          CL_AllocRemapInfo:
                              Some(CL_AllocRemapInfo as
                                       unsafe extern "C" fn(_:
                                                                *mut cl_entity_t,
                                                            _: *mut model_t,
                                                            _: libc::c_int,
                                           ...
                                           -> ()),
                          CL_FreeRemapInfo:
                              Some(CL_FreeRemapInfo as
                                       unsafe extern "C" fn(_:
                                                                *mut remap_info_t)
                                           -> ()),
                          CL_UpdateRemapInfo:
                              Some(CL_UpdateRemapInfo as
                                       unsafe extern "C" fn(_:
                                                                *mut cl_entity_t,
                                                            _: libc::c_int,
                                                            _: libc::c_int)
                          ...
                          pfnTextMessageGet:
                              Some(CL_TextMessageGet as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> *mut client_textmessage_t),
                          GetPredictedOrigin:
                              Some(pfnGetPredictedOrigin as
                                       unsafe extern "C" fn(_: *mut vec_t)
                                           -> ()),
                          CL_GetPaletteColor:
                              Some(pfnCL_GetPaletteColor as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut color24),
                          CL_GetScreenInfo:
                              Some(pfnCL_GetScreenInfo as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_int,
                                                            _:
                                                                *mut libc::c_int)
                                           -> ()),
                          SetLocalLightLevel:
                              Some(pfnSetLocalLightLevel as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> ()),
                          Sys_CheckParm:
                              Some(Sys_CheckParm as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_char)
                                           -> libc::c_int),
                          pfnPlayerInfo:
                          ...
                          pfnGetStudioModelInterface:
                              Some(pfnGetStudioModelInterface as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _:
                                                                *mut *mut r_studio_interface_s,
                                                            _:
                          ...
                          _Mem_Alloc:
                              Some(_Mem_Alloc as
                                       unsafe extern "C" fn(_: poolhandle_t,
                                                            _: size_t,
                                                            _: qboolean,
                                                            _:
                                                                *const libc::c_char,
                          ...
                          COM_LoadLibrary:
                              Some(COM_LoadLibrary as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> *mut libc::c_void),
                          COM_FreeLibrary:
                              Some(COM_FreeLibrary as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_void)
                                           -> ()),
                          COM_GetProcAddress:
                              Some(COM_GetProcAddress as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_void,
                                                            _:
                                                                *const libc::c_char)
                          ...
                          FS_FileExists:
                              Some(FS_FileExists as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> libc::c_int),
                          FS_AllowDirectPaths:
                              Some(FS_AllowDirectPaths as
                                       unsafe extern "C" fn(_: qboolean)
                                           -> ()),
                          R_Init_Video:
                              Some(R_Init_Video_ as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> qboolean),
                          R_Free_Video:
                              Some(R_Free_Video as
                                       unsafe extern "C" fn() -> ()),
                          GL_SetAttribute:
                              Some(GL_SetAttribute as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: libc::c_int)
                                           -> libc::c_int),
                          GL_GetAttribute:
                              Some(GL_GetAttribute as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _:
                                                                *mut libc::c_int)
                                           -> libc::c_int),
                          GL_GetProcAddress:
                              Some(GL_GetProcAddress as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_char)
                                           -> *mut libc::c_void),
                          GL_SwapBuffers:
                              Some(GL_SwapBuffers as
                                       unsafe extern "C" fn() -> ()),
                          SW_CreateBuffer:
                              Some(SW_CreateBuffer as
                                       unsafe extern "C" fn(_: libc::c_int,
                                                            _: libc::c_int,
                                                            _: *mut uint,
                                                            _: *mut uint,
                                           ...
                                           -> qboolean),
                          SW_LockBuffer:
                              Some(SW_LockBuffer as
                                       unsafe extern "C" fn()
                                           -> *mut libc::c_void),
                          SW_UnlockBuffer:
                              Some(SW_UnlockBuffer as
                                       unsafe extern "C" fn() -> ()),
                          BuildGammaTable:
                              Some(BuildGammaTable as
                                       unsafe extern "C" fn(_: libc::c_float,
                                                            _: libc::c_float)
                                           -> ()),
                          LightToTexGamma:
                              Some(LightToTexGamma as
                                       unsafe extern "C" fn(_: byte) -> byte),
                          R_DoResetGamma:
                              Some(R_DoResetGamma as
                                       unsafe extern "C" fn() -> qboolean),
                          GetLightStyle:
                              Some(CL_GetLightStyle as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut lightstyle_t),
                          GetDynamicLight:
                              Some(CL_GetDynamicLight as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut dlight_t),
                          GetEntityLight:
                              Some(CL_GetEntityLight as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *mut dlight_t),
                          R_FatPVS:
                              Some(R_FatPVS as
                                       unsafe extern "C" fn(_: *const vec_t,
                                           ...
                                           -> libc::c_int),
                          GetOverviewParms:
                              Some(GL_GetOverviewParms as
                                       unsafe extern "C" fn()
                                           -> *const ref_overview_t),
                          pfnTime:
                          ...
                          pfnGetMoveVars:
                              Some(pfnGetMoveVars as
                                       unsafe extern "C" fn()
                                           -> *mut movevars_t),
                          Image_AddCmdFlags:
                              Some(Image_AddCmdFlags as
                                       unsafe extern "C" fn(_: uint) -> ()),
                          Image_SetForceFlags:
                              Some(Image_SetForceFlags as
                                       unsafe extern "C" fn(_: uint) -> ()),
                          Image_ClearForceFlags:
                              Some(Image_ClearForceFlags as
                                       unsafe extern "C" fn() -> ()),
                          Image_CustomPalette:
                              Some(Image_CustomPalette as
                                       unsafe extern "C" fn() -> qboolean),
                          Image_Process:
                              Some(Image_Process as
                                       unsafe extern "C" fn(_:
                                                                *mut *mut rgbdata_t,
                                                            _: libc::c_int,
                                                            _: libc::c_int,
                          ...
                          FS_LoadImage:
                              Some(FS_LoadImage as
                                       unsafe extern "C" fn(_:
                                           ...
                                           -> *mut rgbdata_t),
                          FS_SaveImage:
                              Some(FS_SaveImage as
                                       unsafe extern "C" fn(_:
                                                                *const libc::c_char,
                                                            _: *mut rgbdata_t)
                                           -> qboolean),
                          FS_CopyImage:
                              Some(FS_CopyImage as
                                       unsafe extern "C" fn(_: *mut rgbdata_t)
                                           -> *mut rgbdata_t),
                          FS_FreeImage:
                              Some(FS_FreeImage as
                                       unsafe extern "C" fn(_: *mut rgbdata_t)
                                           -> ()),
                          Image_SetMDLPointer:
                              Some(Image_SetMDLPointer as
                                       unsafe extern "C" fn(_: *mut byte)
                                           -> ()),
                          Image_GetPool:
                              Some(pfnImage_GetPool as
                                       unsafe extern "C" fn()
                                           -> poolhandle_t),
                          Image_GetPFDesc:
                              Some(pfnImage_GetPFDesc as
                                       unsafe extern "C" fn(_: libc::c_int)
                                           -> *const bpc_desc_t),
                          pfnDrawNormalTriangles:
                              Some(pfnDrawNormalTriangles as
                                       unsafe extern "C" fn() -> ()),
                          pfnDrawTransparentTriangles:
                              Some(pfnDrawTransparentTriangles as
                                       unsafe extern "C" fn() -> ()),
                          drawFuncs: &mut clgame.drawFuncs,};
            init
        }
}
#[used]
