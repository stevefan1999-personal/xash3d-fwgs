...
extern "C" {
    ...
    pub type demo_api_s;
    #[no_mangle]
    fn CL_IsBackgroundMap() -> qboolean;
    #[no_mangle]
    fn CL_IsBackgroundDemo() -> qboolean;
    #[no_mangle]
    ...
    #[no_mangle]
    fn Platform_MouseMove(x: *mut libc::c_float, y: *mut libc::c_float);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut touch_enable: *mut convar_t;
    #[no_mangle]
    ...
    fn Touch_Shutdown();
    #[no_mangle]
    fn Touch_GetMove(forward: *mut libc::c_float, side: *mut libc::c_float,
                     yaw: *mut libc::c_float, pitch: *mut libc::c_float);
    #[no_mangle]
    ...
    fn Joy_Init();
    #[no_mangle]
    fn Joy_FinalizeMove(fw: *mut libc::c_float, side: *mut libc::c_float,
                        dpitch: *mut libc::c_float, dyaw: *mut libc::c_float);
    #[no_mangle]
    static mut cl: client_t;
    #[no_mangle]
    fn UI_ShowCursor(show: qboolean);
    #[no_mangle]
    fn UI_MouseInRect() -> qboolean;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct inputstate_s {
    pub lastpitch: libc::c_float,
    pub lastyaw: libc::c_float,
}
/*
...
*/
#[no_mangle]
pub static mut in_mousecursor: *mut libc::c_void =
    0 as *const libc::c_void as *mut libc::c_void;
#[no_mangle]
pub static mut in_mouseactive: qboolean = false_0;
// false when not focus app
#[no_mangle]
pub static mut in_mouseinitialized: qboolean = false_0;
#[no_mangle]
pub static mut in_mouse_suspended: qboolean = false_0;
#[no_mangle]
pub static mut in_lastvalidpos: POINT = POINT{x: 0, y: 0,};
#[no_mangle]
pub static mut in_mouse_savedpos: qboolean = false_0;
static mut inputstate: inputstate_s =
    inputstate_s{lastpitch: 0., lastyaw: 0.,};
#[no_mangle]
pub static mut m_enginemouse: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut m_pitch: *mut convar_t = 0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut m_yaw: *mut convar_t = 0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut m_enginesens: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut m_ignore: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut cl_forwardspeed: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut cl_sidespeed: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut cl_backspeed: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut look_filter: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
#[no_mangle]
pub static mut m_rawinput: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
/*
================
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_CollectInputDevices() -> uint {
    let mut ret: uint = 0 as libc::c_int as uint;
    if (*m_ignore).value == 0. {
        // no way to check is mouse connected, so use cvar only
    ...
    Con_Reportf(b"Connected devices: %s%s%s%s\n\x00" as *const u8 as
                ...
                if ret &
                       ((1 as libc::c_int) << 2 as libc::c_int) as
                           libc::c_uint != 0 {
                    b"joy \x00" as *const u8 as *const libc::c_char
                } else { b"\x00" as *const u8 as *const libc::c_char },
                if ret &
                       ((1 as libc::c_int) << 3 as libc::c_int) as
                           libc::c_uint != 0 {
                    b"vr \x00" as *const u8 as *const libc::c_char
                } else { b"\x00" as *const u8 as *const libc::c_char });
    return ret;
}
/*
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_LockInputDevices(mut lock: qboolean) {
    extern "C" {
        #[no_mangle]
        static mut joy_enable: *mut convar_t;
    } // private to input system
    if lock as u64 != 0 {
        (*m_ignore).flags =
            (*m_ignore).flags | (1 as libc::c_int) << 17 as libc::c_int;
        (*joy_enable).flags =
            (*joy_enable).flags | (1 as libc::c_int) << 17 as libc::c_int;
        (*touch_enable).flags =
            (*touch_enable).flags | (1 as libc::c_int) << 17 as libc::c_int
    } else {
        (*m_ignore).flags =
            (*m_ignore).flags & !((1 as libc::c_int) << 17 as libc::c_int);
        (*joy_enable).flags =
...
pub unsafe extern "C" fn IN_StartupMouse() {
    m_ignore =
        Cvar_Get(b"m_ignore\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"ignore mouse events\x00" as *const u8 as
                     *const libc::c_char);
    m_enginemouse =
        Cvar_Get(b"m_enginemouse\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"read mouse events in engine instead of client\x00" as
                     *const u8 as *const libc::c_char);
    m_enginesens =
        Cvar_Get(b"m_enginesens\x00" as *const u8 as *const libc::c_char,
                 b"0.3\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"mouse sensitivity, when m_enginemouse enabled\x00" as
                     *const u8 as *const libc::c_char);
    m_pitch =
        Cvar_Get(b"m_pitch\x00" as *const u8 as *const libc::c_char,
                 ...
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"mouse pitch value\x00" as *const u8 as
                     *const libc::c_char);
    m_yaw =
        Cvar_Get(b"m_yaw\x00" as *const u8 as *const libc::c_char,
                 ...
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"mouse yaw value\x00" as *const u8 as *const libc::c_char);
    look_filter =
        Cvar_Get(b"look_filter\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"filter look events making it smoother\x00" as *const u8 as
                     *const libc::c_char);
    m_rawinput =
        Cvar_Get(b"m_rawinput\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"enable mouse raw input\x00" as *const u8 as
                     *const libc::c_char);
    // You can use -nomouse argument to prevent using mouse from client
	// -noenginemouse will disable all mouse input
    if Sys_CheckParm(b"-noenginemouse\x00" as *const u8 as
                         *const libc::c_char) != 0 {
        return
    }
    in_mouseinitialized = true_0;
}
unsafe extern "C" fn IN_ActivateCursor() {
    if cls.key_dest as libc::c_uint == key_menu as libc::c_int as libc::c_uint
       {
        SDL_SetCursor(in_mousecursor as *mut SDL_Cursor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn IN_SetCursor(mut hCursor: *mut libc::c_void) {
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_MouseSavePos() {
    if in_mouseactive as u64 == 0 { return }
    Platform_GetMousePos(&mut in_lastvalidpos.x, &mut in_lastvalidpos.y);
    in_mouse_savedpos = true_0;
}
/*
===========
IN_MouseRestorePos
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_MouseRestorePos() {
    if in_mouse_savedpos as u64 == 0 { return }
    Platform_SetMousePos(in_lastvalidpos.x, in_lastvalidpos.y);
    in_mouse_savedpos = false_0;
}
/*
===========
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_ToggleClientMouse(mut newstate: libc::c_int,
                                              mut oldstate: libc::c_int) {
    if newstate == oldstate { return }
    if oldstate == key_game as libc::c_int {
        if cls.initialized as u64 != 0 {
            clgame.dllFuncs.IN_DeactivateMouse.expect("non-null function pointer")();
        }
    } else if newstate == key_game as libc::c_int {
        ...
        if if !touch_enable.is_null() && (*touch_enable).value != 0.0f32 {
            ...
            if clgame.dllFuncs.pfnLookEvent.is_some() ||
                   clgame.client_dll_uses_sdl as libc::c_uint != 0 &&
                       (if !m_rawinput.is_null() &&
                               (*m_rawinput).value != 0.0f32 {
                            true_0 as libc::c_int
                        } else { false_0 as libc::c_int }) != 0 {
        ...
        if cls.initialized as u64 != 0 {
            clgame.dllFuncs.IN_ActivateMouse.expect("non-null function pointer")();
        }
    }
    if (newstate == key_menu as libc::c_int ||
            newstate == key_console as libc::c_int ||
            newstate == key_message as libc::c_int) &&
           (CL_IsBackgroundMap() as u64 == 0 ||
                CL_IsBackgroundDemo() as libc::c_uint != 0) {
        SDL_SetWindowGrab(host.hWnd as *mut SDL_Window, SDL_FALSE);
        if clgame.dllFuncs.pfnLookEvent.is_some() ||
               clgame.client_dll_uses_sdl as libc::c_uint != 0 &&
                   (if !m_rawinput.is_null() && (*m_rawinput).value != 0.0f32
                       {
                        true_0 as libc::c_int
                    } else { false_0 as libc::c_int }) != 0 {
            SDL_SetRelativeMouseMode(SDL_FALSE);
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_ActivateMouse(mut force: qboolean) {
    let mut width: libc::c_int = 0; // VGUI controls
    let mut height: libc::c_int = 0;
    static mut oldstate: libc::c_int = 0;
    if in_mouseinitialized as u64 == 0 { return }
    if CL_Active() != 0 && host.mouse_visible as libc::c_uint != 0 &&
           force as u64 == 0 {
        return
    }
    if cls.key_dest as libc::c_uint == key_menu as libc::c_int as libc::c_uint
        ...
        if in_mouse_suspended as u64 == 0 && UI_MouseInRect() as u64 == 0 {
            in_mouse_suspended = true_0
        }
        if oldstate as libc::c_uint != in_mouse_suspended as libc::c_uint {
            if in_mouse_suspended as u64 != 0 {
                // / TODO: Platform_ShowCursor
                if touch_emulate.is_null() {
                    SDL_ShowCursor(SDL_FALSE as
                                       libc::c_int); // re-initialize mouse
                }
                UI_ShowCursor(false_0);
            }
        }
        oldstate = in_mouse_suspended as libc::c_int;
        if in_mouse_suspended as u64 != 0 {
            in_mouse_suspended = false_0;
            in_mouseactive = false_0;
            UI_ShowCursor(true_0);
        }
    }
    if in_mouseactive as u64 != 0 { return }
    in_mouseactive = true_0;
    if UI_IsVisible() as u64 != 0 { return }
...
pub unsafe extern "C" fn IN_DeactivateMouse() {
    if in_mouseinitialized as u64 == 0 || in_mouseactive as u64 == 0 {
        return
    }
    if cls.key_dest as libc::c_uint == key_game as libc::c_int as libc::c_uint
       {
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_MouseMove() {
    let mut current_pos: POINT = POINT{x: 0, y: 0,};
    if in_mouseinitialized as u64 == 0 || in_mouseactive as u64 == 0 ||
           UI_IsVisible() as u64 == 0 {
        return
    }
    // find mouse movement
    Platform_GetMousePos(&mut current_pos.x, &mut current_pos.y);
    ...
    if UI_IsVisible() as u64 != 0 { SDL_ShowCursor(SDL_TRUE as libc::c_int); }
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_MouseEvent() {
    ...
    if if !touch_emulate.is_null() && (*touch_emulate).value != 0.0f32 {
        ...
        if Key_IsDown(134 as libc::c_int) != 0 {
            Touch_KeyEvent(243 as libc::c_int,
                           2 as libc::c_int); // igonre mouse warp event
        } else {
            Touch_KeyEvent(241 as libc::c_int,
                           2 as
                               libc::c_int); // next mouse event will be mouse warp
        }
    }
    if in_mouseinitialized as u64 == 0 || in_mouseactive as u64 == 0 {
        return
    }
    if (*m_ignore).value != 0. { return }
    if cls.key_dest as libc::c_uint == key_game as libc::c_int as libc::c_uint
       {
        static mut ignore: qboolean = false_0;
        let mut x: libc::c_int = 0;
        let mut y: libc::c_int = 0;
        Platform_GetMousePos(&mut x, &mut y);
        if host.mouse_visible as u64 != 0 {
            SDL_ShowCursor(SDL_TRUE as libc::c_int);
        } else if if !touch_emulate.is_null() &&
                         (*touch_emulate).value != 0.0f32 {
                      true_0 as libc::c_int
                  } else { false_0 as libc::c_int } == 0 {
            SDL_ShowCursor(SDL_FALSE as libc::c_int);
        }
        if x < host.window_center_x / 2 as libc::c_int ||
               y < host.window_center_y / 2 as libc::c_int ||
               x >
                   host.window_center_x +
                       host.window_center_x / 2 as libc::c_int ||
               y >
                   host.window_center_y +
                       host.window_center_y / 2 as libc::c_int {
            Platform_SetMousePos(host.window_center_x, host.window_center_y);
            ignore = true_0;
            return
        }
        if ignore as u64 == 0 {
            if (*m_enginemouse).value == 0. {
                // a1ba: mouse keys are now separated
				// so pass 0 here
                clgame.dllFuncs.IN_MouseEvent.expect("non-null function pointer")(0
                                                                                      as
                                                                                      libc::c_int); // reset relative state
            }
        } else {
            SDL_GetRelativeMouseState(0 as *mut libc::c_int,
                                      0 as *mut libc::c_int);
...
pub unsafe extern "C" fn IN_Init() {
    cl_forwardspeed =
        Cvar_Get(b"cl_forwardspeed\x00" as *const u8 as *const libc::c_char,
                 b"400\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"Default forward move speed\x00" as *const u8 as
                     *const libc::c_char); // common joystick support init
    cl_backspeed =
        Cvar_Get(b"cl_backspeed\x00" as *const u8 as *const libc::c_char,
                 b"400\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"Default back move speed\x00" as *const u8 as
                     *const libc::c_char);
    cl_sidespeed =
        Cvar_Get(b"cl_sidespeed\x00" as *const u8 as *const libc::c_char,
                 b"400\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int |
                     (1 as libc::c_int) << 11 as libc::c_int,
                 b"Default side move speed\x00" as *const u8 as
                     *const libc::c_char);
...
// Side stop
unsafe extern "C" fn IN_JoyAppendMove(mut cmd: *mut usercmd_t,
                                      mut forwardmove: libc::c_float,
                                      mut sidemove: libc::c_float) {
    static mut moveflags: uint =
        (1 as libc::c_uint) << 4 as libc::c_int |
            (1 as libc::c_uint) << 5 as libc::c_int;
    if forwardmove != 0. {
        (*cmd).forwardmove = forwardmove * (*cl_forwardspeed).value
    }
    if sidemove != 0. { (*cmd).sidemove = sidemove * (*cl_sidespeed).value }
    if forwardmove != 0. {
        moveflags &= !((1 as libc::c_uint) << 4 as libc::c_int)
    } else if moveflags & (1 as libc::c_uint) << 4 as libc::c_int == 0 {
        Cmd_ExecuteString(b"-back\x00" as *const u8 as *const libc::c_char);
        Cmd_ExecuteString(b"-forward\x00" as *const u8 as
                              *const libc::c_char);
        moveflags |= (1 as libc::c_uint) << 4 as libc::c_int
    }
    if sidemove != 0. {
        moveflags &= !((1 as libc::c_uint) << 5 as libc::c_int)
    } else if moveflags & (1 as libc::c_uint) << 5 as libc::c_int == 0 {
        Cmd_ExecuteString(b"-moveleft\x00" as *const u8 as
                              *const libc::c_char);
        Cmd_ExecuteString(b"-moveright\x00" as *const u8 as
                              *const libc::c_char);
        moveflags |= (1 as libc::c_uint) << 5 as libc::c_int
    }
    if forwardmove > 0.7f32 &&
           moveflags & (1 as libc::c_uint) << 0 as libc::c_int == 0 {
        moveflags |= (1 as libc::c_uint) << 0 as libc::c_int;
        Cmd_ExecuteString(b"+forward\x00" as *const u8 as
                              *const libc::c_char);
    } else if forwardmove < 0.7f32 &&
                  moveflags & (1 as libc::c_uint) << 0 as libc::c_int != 0 {
        moveflags &= !((1 as libc::c_uint) << 0 as libc::c_int);
        Cmd_ExecuteString(b"-forward\x00" as *const u8 as
                              *const libc::c_char);
    ...
    if forwardmove < -0.7f32 &&
           moveflags & (1 as libc::c_uint) << 1 as libc::c_int == 0 {
        moveflags |= (1 as libc::c_uint) << 1 as libc::c_int;
        Cmd_ExecuteString(b"+back\x00" as *const u8 as *const libc::c_char);
    } else if forwardmove > -0.7f32 &&
                  moveflags & (1 as libc::c_uint) << 1 as libc::c_int != 0 {
        moveflags &= !((1 as libc::c_uint) << 1 as libc::c_int);
    ...
    if sidemove > 0.9f32 &&
           moveflags & (1 as libc::c_uint) << 3 as libc::c_int == 0 {
        moveflags |= (1 as libc::c_uint) << 3 as libc::c_int;
        Cmd_ExecuteString(b"+moveright\x00" as *const u8 as
                              *const libc::c_char);
    } else if sidemove < 0.9f32 &&
                  moveflags & (1 as libc::c_uint) << 3 as libc::c_int != 0 {
        moveflags &= !((1 as libc::c_uint) << 3 as libc::c_int);
        Cmd_ExecuteString(b"-moveright\x00" as *const u8 as
                              *const libc::c_char);
    ...
    if sidemove < -0.9f32 &&
           moveflags & (1 as libc::c_uint) << 2 as libc::c_int == 0 {
        moveflags |= (1 as libc::c_uint) << 2 as libc::c_int;
        Cmd_ExecuteString(b"+moveleft\x00" as *const u8 as
                              *const libc::c_char);
    } else if sidemove > -0.9f32 &&
                  moveflags & (1 as libc::c_uint) << 2 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn IN_CollectInput(mut forward: *mut libc::c_float,
                                         mut side: *mut libc::c_float,
                                         mut pitch: *mut libc::c_float,
                                         mut yaw: *mut libc::c_float,
                                         mut includeMouse: qboolean,
                                         mut includeSdlMouse: qboolean) {
    if includeMouse as libc::c_uint != 0 &&
           includeSdlMouse as libc::c_uint != 0 {
        let mut x: libc::c_float = 0.;
        let mut y: libc::c_float = 0.;
        Platform_MouseMove(&mut x, &mut y);
        *pitch += y * (*m_pitch).value;
        *yaw -= x * (*m_yaw).value
    }
    Joy_FinalizeMove(forward, side, yaw, pitch);
    Touch_GetMove(forward, side, yaw, pitch);
    if (*look_filter).value != 0. {
        *pitch =
            (inputstate.lastpitch + *pitch) /
                2 as libc::c_int as libc::c_float;
        *yaw =
            (inputstate.lastyaw + *yaw) / 2 as libc::c_int as libc::c_float;
        inputstate.lastpitch = *pitch;
...
*/
#[no_mangle]
pub unsafe extern "C" fn IN_EngineAppendMove(mut frametime: libc::c_float,
                                             mut cmd1: *mut libc::c_void,
                                             mut active: qboolean) {
    let mut forward: libc::c_float =
        0.; //( (float)cl.local.scr_fov / (float)90.0f );
    let mut side: libc::c_float = 0.;
    let mut pitch: libc::c_float = 0.;
    let mut yaw: libc::c_float = 0.;
    let mut cmd: *mut usercmd_t = cmd1 as *mut usercmd_t;
    if clgame.dllFuncs.pfnLookEvent.is_some() { return }
    if cls.key_dest as libc::c_uint != key_game as libc::c_int as libc::c_uint
           || cl.paused as libc::c_uint != 0 || cl.intermission != 0 {
        return
    }
    ...
    forward = side;
    if active as u64 != 0 {
        let mut sensitivity: libc::c_float =
            1 as libc::c_int as libc::c_float;
        IN_CollectInput(&mut forward, &mut side, &mut pitch, &mut yaw,
                        (in_mouseinitialized as libc::c_uint != 0 &&
                             (if !m_ignore.is_null() &&
                                     (*m_ignore).value != 0.0f32 {
                                  true_0 as libc::c_int
                              } else { false_0 as libc::c_int }) == 0) as
                            libc::c_int as qboolean,
                        (*m_enginemouse).value as qboolean);
        IN_JoyAppendMove(cmd, forward, side);
        if pitch != 0. || yaw != 0. {
            (*cmd).viewangles[1 as libc::c_int as usize] += yaw * sensitivity;
            (*cmd).viewangles[0 as libc::c_int as usize] +=
                pitch * sensitivity;
            (*cmd).viewangles[0 as libc::c_int as usize] =
                if (*cmd).viewangles[0 as libc::c_int as usize] >=
                       -(90 as libc::c_int) as libc::c_float {
                    if (*cmd).viewangles[0 as libc::c_int as usize] <
                           90 as libc::c_int as libc::c_float {
                        (*cmd).viewangles[0 as libc::c_int as usize]
                    } else { 90 as libc::c_int as libc::c_float }
                } else { -(90 as libc::c_int) as libc::c_float };
...
*/
#[no_mangle]
pub unsafe extern "C" fn Host_InputFrame() {
    let mut shutdownMouse: qboolean = false_0;
    let mut forward: libc::c_float = 0 as libc::c_int as libc::c_float;
    let mut side: libc::c_float = 0 as libc::c_int as libc::c_float;
    let mut pitch: libc::c_float = 0 as libc::c_int as libc::c_float;
    let mut yaw: libc::c_float = 0 as libc::c_int as libc::c_float;
    Sys_SendKeyEvents();
    if clgame.dllFuncs.pfnLookEvent.is_some() {
        IN_CollectInput(&mut forward, &mut side, &mut pitch, &mut yaw,
                        (in_mouseinitialized as libc::c_uint != 0 &&
                            ...
                            libc::c_int as qboolean, true_0);
        if cls.key_dest as libc::c_uint ==
               key_game as libc::c_int as libc::c_uint {
            clgame.dllFuncs.pfnLookEvent.expect("non-null function pointer")(yaw,
                                                                             pitch);
            clgame.dllFuncs.pfnMoveEvent.expect("non-null function pointer")(forward,
                                                                             side);
        }
    }
    if in_mouseinitialized as u64 == 0 { return }
    if host.status as libc::c_uint !=
           HOST_FRAME as libc::c_int as libc::c_uint {
        IN_DeactivateMouse();
        return
    }
    // release mouse during pause or console typeing
    if cl.paused as libc::c_uint != 0 &&
           cls.key_dest as libc::c_uint ==
               key_game as libc::c_int as libc::c_uint {
        shutdownMouse = true_0
    }
    if shutdownMouse as libc::c_uint != 0 &&
           Cvar_VariableInteger(b"fullscreen\x00" as *const u8 as
                                    *const libc::c_char) == 0 {
        IN_DeactivateMouse();
        return
    }
    IN_ActivateMouse(false_0);
    IN_MouseMove();
}
