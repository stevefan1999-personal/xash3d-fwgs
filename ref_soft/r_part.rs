...
pub unsafe extern "C" fn CL_DrawParticles(mut frametime: libc::c_double,
    ...
    GL_SetRenderMode(kRenderTransAdd as libc::c_int);
    GL_Bind(XASH_TEXTURE0 as libc::c_int, tr.particleTexture as libc::c_uint);
    //pglTexEnvf( GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE );
	//pglDepthMask( GL_FALSE );
    p = cl_active_particles; // get initial size of particle
    while !p.is_null() {
		...
		//		gEngfuncs.LightToTexGamma( pColor->b ), alpha );
            ...
            _TriColor4f(1.0f32 * alpha as libc::c_float /
                            255 as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float *
                            (*pColor).r as libc::c_int as libc::c_float,
                        1.0f32 * alpha as libc::c_float /
                            255 as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float *
                            (*pColor).g as libc::c_int as libc::c_float,
                        1.0f32 * alpha as libc::c_float /
                            255 as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float *
                            (*pColor).b as libc::c_int as libc::c_float,
                        1.0f32);
            TriBegin(2 as libc::c_int);
            TriTexCoord2f(0.0f32, 1.0f32);
            TriVertex3f((*p).org[0 as libc::c_int as usize] -
                            right[0 as libc::c_int as usize] +
                            up[0 as libc::c_int as usize],
                        (*p).org[1 as libc::c_int as usize] -
                            right[1 as libc::c_int as usize] +
...
pub unsafe extern "C" fn CL_DrawTracers(mut frametime: libc::c_double,
    ...
    while !p.is_null() {
        ...
        if CL_CullTracer(p, start.as_mut_ptr() as *const vec_t,
            ...
            let mut pColor: *mut color24 = 0 as *mut color24;
            let mut alpha: libc::c_short = (*p).packedColor;
            ...
            _TriColor4f(1.0f32 * alpha as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float *
                            (*pColor).r as libc::c_int as libc::c_float,
                        1.0f32 * alpha as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float /
                            255 as libc::c_int as libc::c_float *
                            (*pColor).g as libc::c_int as libc::c_float,
                        1.0f32 * alpha as libc::c_int as libc::c_float /
                        ...
                        1.0f32);
            TriBegin(2 as libc::c_int);
            TriTexCoord2f(0.0f32, 0.8f32);
            TriVertex3fv(verts[2 as libc::c_int as usize].as_mut_ptr());
            TriTexCoord2f(1.0f32, 0.8f32);
            TriVertex3fv(verts[3 as libc::c_int as usize].as_mut_ptr());
            TriTexCoord2f(1.0f32, 0.0f32);
            TriVertex3fv(verts[1 as libc::c_int as usize].as_mut_ptr());
            TriTexCoord2f(0.0f32, 0.0f32);
            TriVertex3fv(verts[0 as libc::c_int as usize].as_mut_ptr());
            TriEnd();
        }
        // evaluate position
        (*p).org[0 as libc::c_int as usize] =
        ...
        if (*p).type_0 as libc::c_uint ==
            ...
            (*p).vel[2 as libc::c_int as usize] =
                (gravity as libc::c_double * 0.05f64) as vec_t
        }
        p = (*p).next
    };
    //pglDepthMask( GL_TRUE );
...
pub unsafe extern "C" fn CL_DrawParticlesExternal(mut rvp:
                                                  ...
                                                  mut frametime:
                                                      libc::c_float) {
    let mut oldRI: ref_instance_t = RI;
    ...
    // setup PVS for frame
    memcpy(RI.visbytes.as_mut_ptr() as *mut libc::c_void,
           tr.visbytes.as_mut_ptr() as *const libc::c_void,
           (*gpGlobals).visbytes);
