...
pub unsafe extern "C" fn Mod_LoadSpriteModel(mut mod_0: *mut model_t,
    ...
    if (*pin).version == 1 as libc::c_int ||
        ...
        numi =
            (buffer as
                ...
                *mut libc::c_void as *const libc::c_short
    }
    r_texFlags = texFlags;
    ...
    if numi.is_null() {
        ...
        pframetype =
            (buffer as
                 *const byte).offset(::std::mem::size_of::<dsprite_q1_t>() as
                                         libc::c_ulong as isize) as
                *mut libc::c_void as *const dframetype_t; // pinq1 + 1
        ...
        pframetype =
            src.offset(768 as libc::c_int as isize) as *mut libc::c_void as
                *const dframetype_t;
            ...
            if (*(*psprite).frames.as_mut_ptr().offset(i as isize)).type_0 as
                ...
                pspriteframe =
                    (*(*psprite).frames.as_mut_ptr().offset(i as
                                                                isize)).frameptr;
                GL_FreeTexture((*pspriteframe).gl_texturenum as GLenum);
            } else {
                pspritegroup =
                    (*(*psprite).frames.as_mut_ptr().offset(i as
                                                                isize)).frameptr
...
pub unsafe extern "C" fn R_CullSpriteModel(mut e: *mut cl_entity_t,
 ...
 -> qboolean {
    ...
    sprite_maxs[2 as libc::c_int as usize] =
        sprite_maxs[2 as libc::c_int as usize] +
            *origin.offset(2 as libc::c_int as isize);
    return R_CullModel(e, sprite_mins.as_mut_ptr() as *const vec_t,
                       sprite_maxs.as_mut_ptr() as *const vec_t) as qboolean;
}
/*
================
R_GlowSightDistance
...
pub unsafe extern "C" fn R_DrawSpriteModel(mut e: *mut cl_entity_t) {
    ...
    let mut color2: vec3_t = [0.0f32, 0., 0.];
    if RI.params as libc::c_uint & (1 as libc::c_uint) << 0 as libc::c_int !=
           0 {
        return
    }
    ...
    match (*e).curstate.rendermode {
        4 => {
            pglDepthMask.expect("non-null function pointer")(0 as libc::c_int
                                                                 as
                                                                 GLboolean);
            current_block_29 = 3322716925953924881;
        }
        1 | 2 => { current_block_29 = 3322716925953924881; }
        3 => {
            pglDisable.expect("non-null function pointer")(0xb71 as
                                                               libc::c_int as
                                                               GLenum);
            current_block_29 = 11940459730423779896;
        }
        5 => { current_block_29 = 11940459730423779896; }
        0 | _ => {
    ...
    if R_SpriteHasLightmap(e, (*psprite).texFormat as libc::c_int) as u64 != 0
       {
        ...
        pglAlphaFunc.expect("non-null function pointer")(0x204 as libc::c_int
                                                             as GLenum,
                                                         0.5f32);
    }
    ...
    if (*psprite).facecull == SPR_CULL_NONE as libc::c_int {
        GL_Cull(0 as libc::c_int as GLenum);
    }
    if oldframe == frame {
        // draw the single non-lerped frame
        pglColor4f.expect("non-null function pointer")(color[0 as libc::c_int
                                                                 as usize],
        ...
        ilerp = 1.0f32 - lerp;
        if ilerp != 0.0f32 {
            pglColor4f.expect("non-null function pointer")(color[0 as
                                                                     libc::c_int
                                                                     as
                                                                     usize],
                                                           color[1 as
                                                           ...
                                                           tr.blend * ilerp);
            GL_Bind(XASH_TEXTURE0 as libc::c_int,
                    (*oldframe).gl_texturenum as GLenum);
    ...
    if R_SpriteHasLightmap(e, (*psprite).texFormat as libc::c_int) as u64 != 0
       {
        ...
        pglDepthFunc.expect("non-null function pointer")(0x202 as libc::c_int
                                                             as GLenum);
        ...
        pglTexEnvi.expect("non-null function pointer")(0x2300 as libc::c_int
                                                       ...
                                                       0x2200 as libc::c_int
                                                           as GLenum,
                                                       0x2100 as libc::c_int);
        pglColor4f.expect("non-null function pointer")(color2[0 as libc::c_int
                                                                  as usize],
                                                       color2[1 as libc::c_int
                                                                  as usize],
                                                       color2[2 as libc::c_int
                                                                  as usize],
                                                       tr.blend);
