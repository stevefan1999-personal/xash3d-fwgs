...
extern "C" {
    ...
    #[no_mangle]
    static mut cl_cmdrate: *mut convar_t;
    #[no_mangle]
    static mut cl_updaterate: *mut convar_t;
    #[no_mangle]
    fn Con_RestoreFont();
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct cmdinfo_t {
    pub cmd_lerp: libc::c_float,
    pub size: libc::c_int,
    pub sent: qboolean,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct packet_latency_t {
    pub latency: libc::c_int,
    pub choked: libc::c_int,
}
...
#[no_mangle]
pub static mut net_graph: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
static mut net_graphpos: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
static mut net_graphwidth: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
static mut net_graphheight: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
static mut net_graphsolid: *mut convar_t =
    0 as *const convar_t as *mut convar_t;
static mut net_scale: *mut convar_t = 0 as *const convar_t as *mut convar_t;
static mut netstat_packet_latency: [packet_latency_t; 1024] =
    [packet_latency_t{latency: 0, choked: 0,}; 1024];
static mut netstat_cmdinfo: [cmdinfo_t; 1024] =
    [cmdinfo_t{cmd_lerp: 0., size: 0, sent: false_0,}; 1024];
static mut netcolors: [[byte; 4]; 29] =
    [[255 as libc::c_int as byte, 0 as libc::c_int as byte,
     ...
     [240 as libc::c_int as byte, 127 as libc::c_int as byte,
      63 as libc::c_int as byte, 255 as libc::c_int as byte],
     [255 as libc::c_int as byte, 255 as libc::c_int as byte,
      0 as libc::c_int as byte, 255 as libc::c_int as byte],
     [63 as libc::c_int as byte, 255 as libc::c_int as byte,
      63 as libc::c_int as byte, 150 as libc::c_int as byte], [0; 4], [0; 4],
     [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4],
     [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4], [0; 4],
     [0; 4], [0; 4], [0; 4], [0; 4]];
static mut sendcolor: [byte; 4] =
    [88 as libc::c_int as byte, 29 as libc::c_int as byte,
     130 as libc::c_int as byte, 255 as libc::c_int as byte];
static mut holdcolor: [byte; 4] =
    [255 as libc::c_int as byte, 0 as libc::c_int as byte,
     0 as libc::c_int as byte, 200 as libc::c_int as byte];
static mut extrap_base_color: [byte; 4] =
    [255 as libc::c_int as byte, 255 as libc::c_int as byte,
     255 as libc::c_int as byte, 255 as libc::c_int as byte];
static mut netstat_graph: [netbandwidthgraph_t; 1024] =
    [netbandwidthgraph_t{client: 0,
                         ...
                         msgbytes: 0,
                         voicebytes: 0,}; 1024];
static mut packet_loss: libc::c_float = 0.;
static mut packet_choke: libc::c_float = 0.;
static mut framerate: libc::c_float = 0.0f64 as libc::c_float;
static mut maxmsgbytes: libc::c_int = 0 as libc::c_int;
/*
==========
NetGraph_DrawRect
...
==========
*/
unsafe extern "C" fn NetGraph_DrawRect(mut rect: *mut wrect_t,
                                       mut colors: *mut byte) {
    ref_0.dllFuncs.Color4ub.expect("non-null function pointer")(*colors.offset(0
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize),
                                                                ...
                                                                *colors.offset(3
                                                                                   ...
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize)); // color for this quad
    ref_0.dllFuncs.Vertex3f.expect("non-null function pointer")((*rect).left
                                                                    as
                                                                    libc::c_float,
                                                                (*rect).top as
                                                                    libc::c_float,
...
==========
*/
unsafe extern "C" fn NetGraph_AtEdge(mut x: libc::c_int,
                                     mut width: libc::c_int) -> qboolean {
    if x > 3 as libc::c_int {
        if x >= width - 4 as libc::c_int { return true_0 }
        return false_0
    }
    return true_0;
}
...
==========
*/
unsafe extern "C" fn NetGraph_InitColors() {
    let mut mincolor: [[byte; 3]; 2] = [[0; 3]; 2];
    let mut maxcolor: [[byte; 3]; 2] = [[0; 3]; 2];
    let mut dc: [[libc::c_float; 3]; 2] = [[0.; 3]; 2];
    let mut i: libc::c_int = 0;
    let mut hfrac: libc::c_int = 0;
    let mut f: libc::c_float = 0.;
    mincolor[0 as libc::c_int as usize][0 as libc::c_int as usize] =
        63 as libc::c_int as byte;
    mincolor[0 as libc::c_int as usize][1 as libc::c_int as usize] =
        0 as libc::c_int as byte;
    mincolor[0 as libc::c_int as usize][2 as libc::c_int as usize] =
        100 as libc::c_int as byte;
    maxcolor[0 as libc::c_int as usize][0 as libc::c_int as usize] =
        0 as libc::c_int as byte;
    maxcolor[0 as libc::c_int as usize][1 as libc::c_int as usize] =
        63 as libc::c_int as byte;
    maxcolor[0 as libc::c_int as usize][2 as libc::c_int as usize] =
        255 as libc::c_int as byte;
    mincolor[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        255 as libc::c_int as byte;
    mincolor[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        127 as libc::c_int as byte;
    mincolor[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        0 as libc::c_int as byte;
    maxcolor[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        250 as libc::c_int as byte;
    maxcolor[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        0 as libc::c_int as byte;
    maxcolor[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        0 as libc::c_int as byte;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        dc[0 as libc::c_int as usize][i as usize] =
            (maxcolor[0 as libc::c_int as usize][i as usize] as libc::c_int -
                 mincolor[0 as libc::c_int as usize][i as usize] as
                     libc::c_int) as libc::c_float;
        dc[1 as libc::c_int as usize][i as usize] =
            (maxcolor[1 as libc::c_int as usize][i as usize] as libc::c_int -
                 mincolor[1 as libc::c_int as usize][i as usize] as
                     libc::c_int) as libc::c_float;
        i += 1
    }
    hfrac = 24 as libc::c_int / 3 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 24 as libc::c_int {
        if i < hfrac {
            f = i as libc::c_float / hfrac as libc::c_float;
            netcolors[(5 as libc::c_int + i) as
                          usize][0 as libc::c_int as usize] =
                (mincolor[0 as libc::c_int as
                              usize][0 as libc::c_int as usize] as libc::c_int
                     as libc::c_float +
                     f *
                         dc[0 as libc::c_int as
                                usize][0 as libc::c_int as usize]) as byte;
            netcolors[(5 as libc::c_int + i) as
                          usize][1 as libc::c_int as usize] =
                (mincolor[0 as libc::c_int as
                              usize][1 as libc::c_int as usize] as libc::c_int
                     as libc::c_float +
                     f *
                         dc[0 as libc::c_int as
                                usize][1 as libc::c_int as usize]) as byte;
            netcolors[(5 as libc::c_int + i) as
                          usize][2 as libc::c_int as usize] =
                (mincolor[0 as libc::c_int as
                              usize][2 as libc::c_int as usize] as libc::c_int
                     as libc::c_float +
                     f *
                         dc[0 as libc::c_int as
                                usize][2 as libc::c_int as usize]) as byte
        } else {
            f =
                (i - hfrac) as libc::c_float /
                    (24 as libc::c_int - hfrac) as libc::c_float;
            netcolors[(5 as libc::c_int + i) as
                          usize][0 as libc::c_int as usize] =
                (mincolor[1 as libc::c_int as
                              usize][0 as libc::c_int as usize] as libc::c_int
                     as libc::c_float +
                     f *
                         dc[1 as libc::c_int as
                                usize][0 as libc::c_int as usize]) as byte;
            netcolors[(5 as libc::c_int + i) as
                          usize][1 as libc::c_int as usize] =
                (mincolor[1 as libc::c_int as
...
==========
*/
unsafe extern "C" fn NetGraph_GetFrameData(mut latency: *mut libc::c_float,
                                           mut latency_count:
                                               *mut libc::c_int) {
    let mut i: libc::c_int = 0;
    let mut choke_count: libc::c_int = 0 as libc::c_int;
    let mut loss_count: libc::c_int = 0 as libc::c_int;
    let mut newtime: libc::c_double = Sys_DoubleTime();
    static mut nexttime: libc::c_double = 0 as libc::c_int as libc::c_double;
    let mut loss: libc::c_float = 0.;
    let mut choke: libc::c_float = 0.;
    *latency_count = 0 as libc::c_int;
    *latency = 0.0f32;
    if newtime >= nexttime {
        // soft fading of net peak usage
        maxmsgbytes =
            if 0 as libc::c_int > maxmsgbytes - 50 as libc::c_int {
                0 as libc::c_int
            } else { (maxmsgbytes) - 50 as libc::c_int };
        nexttime = newtime + 0.05f64
    }
    i =
    ...
    while i as libc::c_uint <= cls.netchan.incoming_sequence {
        let mut f: *mut frame_t =
            cl.frames.as_mut_ptr().offset((i &
                                               CL_UPDATE_BACKUP -
                                                   1 as libc::c_int) as
                                              isize);
        let mut p: *mut packet_latency_t =
            netstat_packet_latency.as_mut_ptr().offset((i &
                                                            1024 as
                                                                libc::c_int -
                                                                1 as
                                                                    libc::c_int)
                                                           as isize);
        let mut g: *mut netbandwidthgraph_t =
            netstat_graph.as_mut_ptr().offset((i &
                                                   1024 as libc::c_int -
                                                       1 as libc::c_int) as
                                                  isize);
        (*p).choked = (*f).choked as libc::c_int;
        if (*p).choked != 0 { choke_count += 1 }
        if (*f).valid as u64 == 0 {
            (*p).latency = 9998 as libc::c_int
            // broken delta
        } else if (*f).receivedtime == -1.0f64 {
            (*p).latency = 9999 as libc::c_int; // dropped
            loss_count += 1
        } else if (*f).receivedtime == -3.0f64 {
            (*p).latency = 9997 as libc::c_int
            // skipped
        } else {
            let mut frame_latency: libc::c_int =
                if (1.0f32 as libc::c_double) < (*f).latency {
                    1.0f32 as libc::c_double
                } else { (*f).latency } as libc::c_int;
            (*p).latency =
                ((frame_latency as libc::c_float + 0.1f32) / 1.1f32 *
                     ((*net_graphheight).value -
                          24 as libc::c_int as libc::c_float -
                          2 as libc::c_int as libc::c_float)) as libc::c_int;
            if i as libc::c_uint >
                   cls.netchan.incoming_sequence.wrapping_sub(8 as libc::c_int
                                                                  as
                                                                  libc::c_uint)
               {
                *latency =
                    (*latency as libc::c_double +
                         1000.0f32 as libc::c_double * (*f).latency) as
                        libc::c_float;
                *latency_count += 1
            }
        }
        memcpy(g as *mut libc::c_void,
               &mut (*f).graphdata as *mut netbandwidthgraph_t as
                   *const libc::c_void,
               ::std::mem::size_of::<netbandwidthgraph_t>() as libc::c_ulong);
        if (*g).msgbytes as libc::c_int > maxmsgbytes {
            maxmsgbytes = (*g).msgbytes as libc::c_int
        }
        i += 1
    }
    if maxmsgbytes > 1000 as libc::c_int { maxmsgbytes = 1000 as libc::c_int }
    i =
        cls.netchan.outgoing_sequence.wrapping_sub(CL_UPDATE_BACKUP as
                                                       libc::c_uint).wrapping_add(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      libc::c_uint)
            as libc::c_int;
    while i as libc::c_uint <= cls.netchan.outgoing_sequence {
        netstat_cmdinfo[(i & 1024 as libc::c_int - 1 as libc::c_int) as
                            usize].cmd_lerp =
            cl.commands[(i & CL_UPDATE_BACKUP - 1 as libc::c_int) as
                            usize].frame_lerp;
        netstat_cmdinfo[(i & 1024 as libc::c_int - 1 as libc::c_int) as
                            usize].sent =
            if cl.commands[(i & CL_UPDATE_BACKUP - 1 as libc::c_int) as
                               usize].heldback as libc::c_uint != 0 {
    ...
    // packet loss
    loss =
        100.0f32 * loss_count as libc::c_float /
            CL_UPDATE_BACKUP as libc::c_float;
    packet_loss = 0.5f32 * packet_loss + (1.0f32 - 0.5f32) * loss;
    // packet choke
    choke =
        100.0f32 * choke_count as libc::c_float /
            CL_UPDATE_BACKUP as libc::c_float;
    packet_choke = 0.5f32 * packet_choke + (1.0f32 - 0.5f32) * choke;
}
/*
===========
NetGraph_DrawTimes
...
===========
*/
unsafe extern "C" fn NetGraph_DrawTimes(mut rect: wrect_t, mut x: libc::c_int,
                                        mut w: libc::c_int) {
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    let mut extrap_point: libc::c_int = 24 as libc::c_int / 3 as libc::c_int;
    let mut a: libc::c_int = 0;
    let mut h: libc::c_int = 0;
    let mut colors: rgba_t =
        [(0.9f64 * 255 as libc::c_int as libc::c_double) as byte,
         (0.9f64 * 255 as libc::c_int as libc::c_double) as byte,
         (0.7f64 * 255 as libc::c_int as libc::c_double) as byte,
         255 as libc::c_int as byte];
    let mut fill: wrect_t = wrect_t{left: 0, right: 0, top: 0, bottom: 0,};
    a = 0 as libc::c_int;
    while a < w {
        i =
            (cls.netchan.outgoing_sequence.wrapping_sub(a as libc::c_uint) &
                 (1024 as libc::c_int - 1 as libc::c_int) as libc::c_uint) as
                libc::c_int;
        h =
            (netstat_cmdinfo[i as usize].cmd_lerp / 3.0f32 *
                 24 as libc::c_int as libc::c_float) as libc::c_int;
        fill.left = x + w - a - 1 as libc::c_int;
        fill.bottom = 1 as libc::c_int;
        fill.right = fill.bottom;
        fill.top = rect.top + rect.bottom - 4 as libc::c_int;
        if h >= extrap_point {
            let mut start: libc::c_int = 0 as libc::c_int;
            h -= extrap_point;
            fill.top -= extrap_point;
            if (*net_graphsolid).value == 0. {
                fill.top -= h - 1 as libc::c_int;
                start = h - 1 as libc::c_int
            }
            j = start;
            while j < h {
                NetGraph_DrawRect(&mut fill,
                                  netcolors[(5 as libc::c_int + j +
                                                 extrap_point) as
                                                usize].as_mut_ptr());
                fill.top -= 1;
                j += 1
            ...
            let mut oldh: libc::c_int = h;
            fill.top -= h;
            h = extrap_point - h;
            if (*net_graphsolid).value == 0. { h = 1 as libc::c_int }
            j = 0 as libc::c_int;
            while j < h {
                NetGraph_DrawRect(&mut fill,
                                  netcolors[(5 as libc::c_int + j + oldh) as
                                                usize].as_mut_ptr());
                fill.top -= 1;
                j += 1
            }
        }
        fill.top = rect.top + rect.bottom - 4 as libc::c_int - extrap_point;
        if NetGraph_AtEdge(a, w) as u64 != 0 {
            NetGraph_DrawRect(&mut fill, extrap_base_color.as_mut_ptr());
        }
        fill.top = rect.top + rect.bottom - 4 as libc::c_int;
        if netstat_cmdinfo[i as usize].sent as u64 != 0 {
            NetGraph_DrawRect(&mut fill, sendcolor.as_mut_ptr());
        } else { NetGraph_DrawRect(&mut fill, holdcolor.as_mut_ptr()); }
        a += 1
    };
}
//left = x
...
===========
*/
unsafe extern "C" fn NetGraph_DrawHatches(mut x: libc::c_int,
                                          mut y: libc::c_int) {
    let mut ystep: libc::c_int =
        (10.0f32 / (*net_scale).value) as libc::c_int;
    let mut colorminor: [byte; 4] =
        [0 as libc::c_int as byte, 63 as libc::c_int as byte,
         63 as libc::c_int as byte, 200 as libc::c_int as byte];
    let mut color: [byte; 4] =
        [0 as libc::c_int as byte, 200 as libc::c_int as byte,
         0 as libc::c_int as byte, 255 as libc::c_int as byte];
    let mut hatch: wrect_t =
        {
            let mut init =
                wrect_s{left: x,
                        right: 4 as libc::c_int,
                        top: y,
                        bottom: 1 as libc::c_int,};
            init
        };
    let mut starty: libc::c_int = 0;
    ystep = if ystep > 1 as libc::c_int { ystep } else { 1 as libc::c_int };
    starty = hatch.top;
    while hatch.top > 0 as libc::c_int &&
              (starty - hatch.top) as libc::c_float * (*net_scale).value <
                  (maxmsgbytes + 50 as libc::c_int) as libc::c_float {
        if ((starty - hatch.top) as libc::c_float * (*net_scale).value) as
               libc::c_int % 50 as libc::c_int == 0 {
            NetGraph_DrawRect(&mut hatch, color.as_mut_ptr());
        } else if ystep > 5 as libc::c_int {
            NetGraph_DrawRect(&mut hatch, colorminor.as_mut_ptr());
        }
        hatch.top -= ystep
    };
}
...
===========
*/
unsafe extern "C" fn NetGraph_DrawTextFields(mut x: libc::c_int,
                                             mut y: libc::c_int,
                                             mut w: libc::c_int,
                                             mut rect: wrect_t,
                                             mut count: libc::c_int,
                                             mut avg: libc::c_float,
                                             mut packet_loss_0: libc::c_int,
                                             mut packet_choke_0: libc::c_int,
                                             mut graphtype: libc::c_int) {
    static mut lastout: libc::c_int = 0;
    let mut colors: rgba_t =
        [(0.9f64 * 255 as libc::c_int as libc::c_double) as byte,
         (0.9f64 * 255 as libc::c_int as libc::c_double) as byte,
         (0.7f64 * 255 as libc::c_int as libc::c_double) as byte,
         255 as libc::c_int as byte];
    let mut ptx: libc::c_int =
        if x + w - 24 as libc::c_int - 1 as libc::c_int > 1 as libc::c_int {
            (x + w - 24 as libc::c_int) - 1 as libc::c_int
        } else { 1 as libc::c_int };
    let mut pty: libc::c_int =
        if rect.top + rect.bottom - 24 as libc::c_int - 3 as libc::c_int >
               1 as libc::c_int {
            (rect.top + rect.bottom - 24 as libc::c_int) - 3 as libc::c_int
        } else { 1 as libc::c_int };
    ...
    let mut last_y: libc::c_int =
        (y as libc::c_float - (*net_graphheight).value) as libc::c_int;
    if count > 0 as libc::c_int {
        avg =
            avg /
                (count as libc::c_double -
                     host.frametime * 0.5f32 as libc::c_double) as
                    libc::c_float;
        if (*cl_updaterate).value > 0.0f32 {
            avg -= 1000.0f32 / (*cl_updaterate).value
        }
        // can't be below zero
        avg = if 0.0f32 > avg { 0.0f32 } else { avg }
    } else { avg = 0.0f64 as libc::c_float }
    // move rolling average
    framerate =
        (0.5f32 as libc::c_double * host.frametime +
             ((1.0f32 - 0.5f32) * framerate) as libc::c_double) as
            libc::c_float;
    Con_SetFont(0 as libc::c_int);
    if framerate > 0.0f32 {
        y = (y as libc::c_float - (*net_graphheight).value) as libc::c_int;
        Con_DrawString(x, y,
                       va(b"%.1f fps\x00" as *const u8 as *const libc::c_char,
                          (1.0f32 / framerate) as libc::c_double),
                       colors.as_mut_ptr());
        if avg > 1.0f32 {
            Con_DrawString(x + 75 as libc::c_int, y,
                           va(b"%i ms\x00" as *const u8 as
                                  *const libc::c_char, avg as libc::c_int),
                           colors.as_mut_ptr());
        }
        y += 15 as libc::c_int;
        out = netstat_cmdinfo[i as usize].size;
        if out == 0 { out = lastout } else { lastout = out }
        Con_DrawString(x, y,
                       va(b"in :  %i %.2f k/s\x00" as *const u8 as
                              *const libc::c_char,
                          netstat_graph[j as usize].msgbytes as libc::c_int,
                          cls.netchan.flow[1 as libc::c_int as
                                               usize].avgkbytespersec as
                              libc::c_double), colors.as_mut_ptr());
        y += 15 as libc::c_int;
        Con_DrawString(x, y,
                       va(b"out:  %i %.2f k/s\x00" as *const u8 as
                              *const libc::c_char, out,
                          cls.netchan.flow[0 as libc::c_int as
                                               usize].avgkbytespersec as
                              libc::c_double), colors.as_mut_ptr());
        y += 15 as libc::c_int;
        if graphtype > 2 as libc::c_int {
            let mut loss: libc::c_int =
                (packet_loss_0 as libc::c_float + 0.5f32 - 0.01f32) as
                    libc::c_int;
            let mut choke: libc::c_int =
                (packet_choke_0 as libc::c_float + 0.5f32 - 0.01f32) as
                    libc::c_int;
            Con_DrawString(x, y,
                           va(b"loss: %i choke: %i\x00" as *const u8 as
                                  *const libc::c_char, loss, choke),
                           colors.as_mut_ptr());
        }
    }
    if graphtype < 3 as libc::c_int {
        Con_DrawString(ptx, pty,
                       va(b"%i/s\x00" as *const u8 as *const libc::c_char,
                          (*cl_cmdrate).value as libc::c_int),
                       colors.as_mut_ptr());
    }
    Con_DrawString(ptx, last_y,
                   va(b"%i/s\x00" as *const u8 as *const libc::c_char,
                      (*cl_updaterate).value as libc::c_int),
                   colors.as_mut_ptr());
    Con_RestoreFont();
}
/*
...
===========
*/
unsafe extern "C" fn NetGraph_DrawDataSegment(mut fill: *mut wrect_t,
                                              mut bytes: libc::c_int,
                                              mut r: byte, mut g: byte,
                                              mut b: byte, mut a: byte)
 -> libc::c_int {
    let mut h: libc::c_float = bytes as libc::c_float / (*net_scale).value;
    let mut colors: [byte; 4] = [r, g, b, a];
    (*fill).top -= h as libc::c_int;
    if (*net_graphsolid).value != 0. {
        (*fill).bottom = h as libc::c_int
    } else { (*fill).bottom = 1 as libc::c_int }
    if (*fill).top > 1 as libc::c_int {
        NetGraph_DrawRect(fill, colors.as_mut_ptr());
...
===========
*/
unsafe extern "C" fn NetGraph_ColorForHeight(mut packet:
                                                 *mut packet_latency_t,
                                             mut color: *mut byte,
                                             mut ping: *mut libc::c_int) {
    match (*packet).latency {
        9999 => {
            memcpy(color as *mut libc::c_void,
                   netcolors[0 as libc::c_int as usize].as_mut_ptr() as
                       *const libc::c_void,
                   (::std::mem::size_of::<byte>() as
                        libc::c_ulong).wrapping_mul(4 as libc::c_int as
                                                        libc::c_ulong)); // dropped
            *ping = 0 as libc::c_int
        }
        9998 => {
            memcpy(color as *mut libc::c_void,
                   netcolors[1 as libc::c_int as usize].as_mut_ptr() as
                       *const libc::c_void,
                   (::std::mem::size_of::<byte>() as
                        libc::c_ulong).wrapping_mul(4 as libc::c_int as
                                                        libc::c_ulong)); // invalid
            *ping = 0 as libc::c_int
        }
        9997 => {
            memcpy(color as *mut libc::c_void,
                   netcolors[2 as libc::c_int as usize].as_mut_ptr() as
                       *const libc::c_void,
                   (::std::mem::size_of::<byte>() as
                        libc::c_ulong).wrapping_mul(4 as libc::c_int as
                                                        libc::c_ulong)); // skipped
            *ping = 0 as libc::c_int
        }
        _ => {
            *ping = 1 as libc::c_int;
            if (*packet).choked != 0 {
                memcpy(color as *mut libc::c_void,
                       netcolors[3 as libc::c_int as usize].as_mut_ptr() as
                           *const libc::c_void,
                       (::std::mem::size_of::<byte>() as
                            libc::c_ulong).wrapping_mul(4 as libc::c_int as
                                                            libc::c_ulong));
                ...
                memcpy(color as *mut libc::c_void,
                       netcolors[4 as libc::c_int as usize].as_mut_ptr() as
                           *const libc::c_void,
                       (::std::mem::size_of::<byte>() as
                            libc::c_ulong).wrapping_mul(4 as libc::c_int as
                                                            libc::c_ulong));
...
===========
*/
unsafe extern "C" fn NetGraph_DrawDataUsage(mut x: libc::c_int,
                                            mut y: libc::c_int,
                                            mut w: libc::c_int,
                                            mut graphtype: libc::c_int) {
    let mut a: libc::c_int = 0; // skip invalid
    let mut i: libc::c_int = 0;
    let mut h: libc::c_int = 0;
    let mut lastvalidh: libc::c_int = 0 as libc::c_int;
    let mut ping: libc::c_int = 0;
    let mut pingheight: libc::c_int =
        ((*net_graphheight).value - 24 as libc::c_int as libc::c_float -
             2 as libc::c_int as libc::c_float) as libc::c_int;
    let mut fill: wrect_t =
        {
            let mut init =
                wrect_s{left: 0 as libc::c_int, right: 0, top: 0, bottom: 0,};
            init
        };
    ...
    while a < w {
        i =
            (cls.netchan.incoming_sequence.wrapping_sub(a as libc::c_uint) &
                 (1024 as libc::c_int - 1 as libc::c_int) as libc::c_uint) as
                libc::c_int;
        h = netstat_packet_latency[i as usize].latency;
        NetGraph_ColorForHeight(&mut *netstat_packet_latency.as_mut_ptr().offset(i
                                                                                     as
                                                                                     isize),
                                color.as_mut_ptr(), &mut ping);
        if ping == 0 { h = lastvalidh } else { lastvalidh = h }
        if h > pingheight { h = pingheight }
        fill.left = x + w - a - 1 as libc::c_int;
        fill.top = y - h;
        fill.right = 1 as libc::c_int;
        fill.bottom = if ping != 0 { 1 as libc::c_int } else { h };
        if ping == 0 {
            if fill.bottom > 3 as libc::c_int {
                fill.bottom = 2 as libc::c_int;
                NetGraph_DrawRect(&mut fill, color.as_mut_ptr());
                fill.top += fill.bottom - 2 as libc::c_int;
                NetGraph_DrawRect(&mut fill, color.as_mut_ptr());
            } else { NetGraph_DrawRect(&mut fill, color.as_mut_ptr()); }
        } else { NetGraph_DrawRect(&mut fill, color.as_mut_ptr()); }
        fill.top = y;
        fill.bottom = 1 as libc::c_int;
        color[0 as libc::c_int as usize] = 0 as libc::c_int as byte;
        color[1 as libc::c_int as usize] = 255 as libc::c_int as byte;
        color[2 as libc::c_int as usize] = 0 as libc::c_int as byte;
        color[3 as libc::c_int as usize] = 160 as libc::c_int as byte;
        if NetGraph_AtEdge(a, w) as u64 != 0 {
            NetGraph_DrawRect(&mut fill, color.as_mut_ptr());
        }
        if !(graphtype < 2 as libc::c_int) {
            ...
            color[0 as libc::c_int as usize] =
                color[1 as libc::c_int as usize];
            fill.top =
                (y as libc::c_float - (*net_graphheight).value -
                     1 as libc::c_int as libc::c_float) as libc::c_int;
            fill.bottom = 1 as libc::c_int;
            if NetGraph_AtEdge(a, w) as u64 != 0 {
                NetGraph_DrawRect(&mut fill, color.as_mut_ptr());
            }
            fill.top -= 1 as libc::c_int;
            if !(netstat_packet_latency[i as usize].latency >
                     9995 as libc::c_int) {
                if !(NetGraph_DrawDataSegment(&mut fill,
                                              netstat_graph[i as usize].client
                                                  as libc::c_int,
                                              255 as libc::c_int as byte,
                                              0 as libc::c_int as byte,
                                              0 as libc::c_int as byte,
                                    ...
                                    if !(NetGraph_DrawDataSegment(&mut fill,
                                        ...
                                        if !(NetGraph_DrawDataSegment(&mut fill,
                                            ...
                                            if !(NetGraph_DrawDataSegment(&mut fill,
                                                ...
                                                fill.bottom =
                                                    1 as libc::c_int;
                                                fill.top -= 2 as libc::c_int;
                                                (NetGraph_DrawDataSegment(&mut fill,
                                                                          netstat_graph[i
                                                                                            as
                                                                                            usize].msgbytes
                                                                              as
...
===========
*/
unsafe extern "C" fn NetGraph_GetScreenPos(mut rect: *mut wrect_t,
                                           mut w: *mut libc::c_int,
                                           mut x: *mut libc::c_int,
                                           mut y: *mut libc::c_int) {
    (*rect).top = 0 as libc::c_int;
    (*rect).left = (*rect).top;
    (*rect).right = refState.width;
    (*rect).bottom = refState.height;
    *w =
        if (1024 as libc::c_int as libc::c_float) < (*net_graphwidth).value {
            1024 as libc::c_int as libc::c_float
        } else { (*net_graphwidth).value } as libc::c_int;
    if (*rect).right < *w + 10 as libc::c_int {
        *w = (*rect).right - 10 as libc::c_int
    }
    // detect x and y position
    match (*net_graphpos).value as libc::c_int {
        1 => {
            // right sided
            *x = (*rect).left + (*rect).right - 5 as libc::c_int - *w
        }
        2 => {
            // center
            *x =
                (*rect).left +
                    ((*rect).right - 10 as libc::c_int - *w) /
                        2 as libc::c_int
        }
        _ => {
            // left sided
            *x = (*rect).left + 5 as libc::c_int
        }
    }
    *y = (*rect).bottom + (*rect).top - 24 as libc::c_int - 5 as libc::c_int;
}
/*
===========
SCR_DrawNetGraph
...
*/
#[no_mangle]
pub unsafe extern "C" fn SCR_DrawNetGraph() {
    let mut rect: wrect_t =
        wrect_t{left: 0,
                right: 0,
                top: 0,
                bottom:
                    0,}; // draw all the fills as a long solid sequence of quads for speedup reasons
    let mut avg_ping: libc::c_float = 0.;
    let mut ping_count: libc::c_int = 0;
    let mut w: libc::c_int = 0;
    let mut x: libc::c_int = 0;
    let mut y: libc::c_int = 0;
    let mut in_graph: *mut kbutton_t = 0 as *mut kbutton_t;
    let mut graphtype: libc::c_int = 0;
    if host.allow_console as u64 == 0 { return }
    if cls.state as libc::c_uint != ca_active as libc::c_int as libc::c_uint {
        return
    }
    in_graph =
        clgame.dllFuncs.KB_Find.expect("non-null function pointer")(b"in_graph\x00"
                                                                        as
                                                                        *const u8
                                                                        as
                                                                        *const libc::c_char)
            as *mut kbutton_t;
    if (*in_graph).state & 1 as libc::c_int != 0 {
        graphtype = 2 as libc::c_int
    } else if (*net_graph).value != 0.0f32 {
        graphtype = (*net_graph).value as libc::c_int
    } else { return }
    if (*net_scale).value <= 0 as libc::c_int as libc::c_float {
        Cvar_SetValue(b"net_scale\x00" as *const u8 as *const libc::c_char,
                      0.1f32);
    }
    NetGraph_GetScreenPos(&mut rect, &mut w, &mut x, &mut y);
    NetGraph_GetFrameData(&mut avg_ping, &mut ping_count);
    NetGraph_DrawTextFields(x, y, w, rect, ping_count, avg_ping,
                            packet_loss as libc::c_int,
                            packet_choke as libc::c_int, graphtype);
    if graphtype < 3 as libc::c_int {
        ...
        ref_0.dllFuncs.GL_Bind.expect("non-null function pointer")(XASH_TEXTURE0
                                                                   ...
                                                                   ref_0.dllFuncs.GL_LoadTexture.expect("non-null function pointer")(b"*white\x00"
                                                                       ...
                                                                       as
                                                                       libc::c_uint);
        ref_0.dllFuncs.Begin.expect("non-null function pointer")(2 as
                                                                     libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn CL_InitNetgraph() {
    net_graph =
        Cvar_Get(b"net_graph\x00" as *const u8 as *const libc::c_char,
                 b"0\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"draw network usage graph\x00" as *const u8 as
                     *const libc::c_char);
    net_graphpos =
        Cvar_Get(b"net_graphpos\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"network usage graph position\x00" as *const u8 as
                     *const libc::c_char);
    net_scale =
        Cvar_Get(b"net_scale\x00" as *const u8 as *const libc::c_char,
                 b"5\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"network usage graph scale level\x00" as *const u8 as
                     *const libc::c_char);
    net_graphwidth =
        Cvar_Get(b"net_graphwidth\x00" as *const u8 as *const libc::c_char,
                 b"192\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"network usage graph width\x00" as *const u8 as
                     *const libc::c_char);
    net_graphheight =
        Cvar_Get(b"net_graphheight\x00" as *const u8 as *const libc::c_char,
                 b"64\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"network usage graph height\x00" as *const u8 as
                     *const libc::c_char);
    net_graphsolid =
        Cvar_Get(b"net_graphsolid\x00" as *const u8 as *const libc::c_char,
                 b"1\x00" as *const u8 as *const libc::c_char,
                 (1 as libc::c_int) << 0 as libc::c_int,
                 b"fill segments in network usage graph\x00" as *const u8 as
                     *const libc::c_char);
    packet_choke = 0.0f64 as libc::c_float;
    packet_loss = packet_choke;
    NetGraph_InitColors();
}
